...
- [📑 導航](#導航)
- [🏗️ 系統架構](#系統架構)
  - [檔案結構層次 (實際 7 層深度)](#檔案結構層次-實際-7-層深度)
  - [核心工作流程](#核心工作流程)
- [💾 資料儲存與配置](#資料儲存與配置)
  - [📂 統一配置系統](#統一配置系統)
  - [🗄️ 核心資料庫](#核心資料庫)
    - [1. 攻擊路徑圖 (attack_graph.pkl)](#1-攻擊路徑圖-attackgraphpkl)
    - [2. 經驗資料庫 (experience.db)](#2-經驗資料庫-experiencedb)
  - [🔧 使用範例](#使用範例)
  - [📚 詳細文檔](#詳細文檔)
- [🧩 核心組件](#核心組件)
  - [🎯 **AI Operation Recorder** (核心協調器)](#ai-operation-recorder-核心協調器)
  - [📊 **Analysis Module** (分析模組)](#analysis-module-分析模組)
    - [核心組件](#核心組件-1)
  - [📨 **Reception Module** (資料接收層)](#reception-module-資料接收層)
    - [核心組件](#核心組件-2)
  - [🛡️ **Threat Intelligence Module** (威脅情報)](#threat-intelligence-module-威脅情報)
    - [7 層深度架構範例](#7-層深度架構範例)
  - [🕸️ **Attack Path Analyzer** (攻擊路徑分析)](#attack-path-analyzer-攻擊路徑分析)
  - [📋 **Reporting Module** (報告生成)](#reporting-module-報告生成)
  - [🔧 **Remediation Module** (修復建議)](#remediation-module-修復建議)
- [🚀 快速開始](#快速開始)
  - [1. 環境準備](#1-環境準備)
  - [2. 配置檢查](#2-配置檢查)
  - [3. 基本使用](#3-基本使用)
...
- [📚 API 參考](#api-參考)
  - [核心 API 端點](#核心-api-端點)
  - [Python API 範例](#python-api-範例)
- [🔧 開發規範與最佳實踐](#開發規範與最佳實踐)
  - [📐 **aiva_common 修護規範遵循**](#aivacommon-修護規範遵循)
    - [✅ **標準導入範例**](#標準導入範例)
    - [� **嚴格禁止的做法**](#嚴格禁止的做法)
    - [🔍 **模組特定枚舉判斷標準**](#模組特定枚舉判斷標準)
    - [📋 **開發檢查清單**](#開發檢查清單)
    - [🛠️ **修復原則**](#修復原則)
- [🔗 相關文檔](#相關文檔)
