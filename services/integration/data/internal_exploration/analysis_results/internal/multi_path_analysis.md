...
- **路徑長度範圍**: 2 - 2 步
- **平均路徑長度**: 2.00 步
- **涉及模組**: 認知核心模組(學習子系統), 認知核心模組, 任務規劃模組, 服務骨幹模組
...
- **路徑長度範圍**: 2 - 2 步
- **平均路徑長度**: 2.00 步
- **涉及模組**: 認知核心模組(學習子系統), 認知核心模組, 任務規劃模組
...
- **路徑長度範圍**: 2 - 2 步
- **平均路徑長度**: 2.00 步
- **涉及模組**: 認知核心模組(學習子系統), 任務規劃模組, 認知核心模組
...
- 共同腳本數: 1
- 路徑 1 獨有: 2 個腳本
  - task_execution_planner, core_service_coordinator
- 路徑 2 獨有: 1 個腳本
  - enhanced_decision_agent

**使用場景差異推測**:

- 路徑 1 主要涉及: 任務規劃模組, 服務骨幹模組, 認知核心模組
- 路徑 2 主要涉及: 認知核心模組
- **差異**: 兩條路徑經過不同的架構模組,可能用於不同的功能場景
