...
- [embedded_knowledge](./embedded_knowledge/README.md)
- [external_knowledge](./external_knowledge/README.md)
- [learning_system](./learning_system/README.md)
- [neural](./neural/README.md)
- [rag](./rag/README.md)

## 📄 檔案概覽 (Files Overview)

- `ai_capability_query.py` - AI 能力查詢系統 - 用戶友好的 AI 分析接口（v2.0 六大模組支持）
- `capability_encoder.py` - AIVA 結構化能力編碼器 (Capability Encoder)
- `capability_orchestrator.py` - 能力編排器 (Capability Orchestrator) - AI 決策引擎核心
- `dispatcher.py` - Cognitive Core Dispatcher - 認知核心發送器
- `external_loop_connector.py` - External Loop Connector - 外部閉環連接器 (v2.0 合規版本)
- `internal_loop_connector.py` - Internal Loop Connector - 內部閉環連接器 (v9.0 更新版本)
