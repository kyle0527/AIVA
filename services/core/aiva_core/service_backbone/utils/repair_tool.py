...
位置: service_backbone/utils/repair_tool.py
...
使用方式:
    from services.core.aiva_core.service_backbone.utils.repair_tool import AIVASystemRepair
    repair = AIVASystemRepair()
