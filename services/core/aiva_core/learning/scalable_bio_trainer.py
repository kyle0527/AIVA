...
class ScalableBioTrainer:
    ...
    def __init__(self, model: Any, config: ScalableBioTrainingConfig | None = None) -> None:
    ...
    def _count_correct_predictions(self, outputs: np.ndarray, targets: np.ndarray) -> int:
        """計算正確預測數量
