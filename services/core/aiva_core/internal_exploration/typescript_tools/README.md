# AIVA TypeScript 工具 - 操作手冊

> **版本**: v2.2.0  
> **最後更新**: 2026-01-07  
> **狀態**: ✅ 生產就緒  
> **檔案數**: 2 個 TypeScript 模組  
> **代碼行數**: 865 行  
...
- [📊 與其他語言工具對比](#-與其他語言工具對比)
- [🐛 疑難排解](#-疑難排解)
- [📚 TypeScript 特有功能](#-typescript-特有功能)
- [🔄 版本歷史](#-版本歷史)
...
**ts2mermaid v2.0** 是 AIVA 專案中與 Python/Go/Rust 工具套件完全功能對等的 TypeScript AST 分析工具。整合了 5 大核心功能模組:

1. **AST 解析與圖形生成** - 將 TypeScript 函數轉換為 Mermaid 流程圖
2. **跨檔案數據流串接** (Stitcher) - 自動追蹤多檔案間的函數呼叫關係
3. **系統架構圖生成** - 產生整體專案的數據流視覺化
4. **自動分類系統** (Classifier) - 按功能將函數歸類(偵察/攻擊/分析/報告/持久化)
5. **CLI 指令手冊生成** - 自動產生可執行的命令腳本
