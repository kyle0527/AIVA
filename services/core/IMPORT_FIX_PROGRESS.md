...
python -m pytest tests/test_module_explorer.py::TestModuleExplorer::test_initialization -v

# 錯誤信息
ModuleNotFoundError: No module named 'services'
File: aiva_core/decision/skill_graph.py:18
Error: from services.integration.capability import CapabilityRegistry
```

### 問題分析
1. **已修復**: `skill_graph.py` 的 `from services.aiva_common` 問題
2. **新問題**: `from services.integration.capability` 無法導入
3. **原因**: `services.integration` 模組也有類似的導入問題需要修復
