...
class Task(BaseModel):
    ...
    status: str = Field(default="pending", description="任務狀態：pending、running、completed、failed")
    ...
    # 掃描配置
    scan_strategy: str = Field(default="normal", description="掃描策略：fast、normal、deep、comprehensive")
    ...
    # 依賴和元數據
    dependencies: list[TaskDependency] = Field(default_factory=list, description="任務依賴列表")
