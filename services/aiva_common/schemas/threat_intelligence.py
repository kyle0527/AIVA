...
from typing import Literal, Any, Dict, List, Optional, Union, ClassVar
...
from ..enums.security import AttackTactic, AttackTechnique, IOCType, IntelSource
...
class STIXDomainObject(BaseModel):
    ...
    created: datetime = Field(default_factory=lambda: datetime.now(UTC), description="建立時間")
    modified: datetime = Field(default_factory=lambda: datetime.now(UTC), description="最後修改時間")
    created_by_ref: Optional[str] = Field(default=None, description="建立者引用")
    revoked: bool = Field(default=False, description="是否已撤銷")
    labels: List[str] = Field(default_factory=list, description="標籤列表")
    confidence: Optional[int] = Field(default=None, ge=0, le=100, description="置信度 (0-100)")
    lang: Optional[str] = Field(default=None, description="語言代碼")
    external_references: List["ExternalReference"] = Field(default_factory=list, description="外部參考")
    object_marking_refs: List[str] = Field(default_factory=list, description="標記參考")
    granular_markings: List["GranularMarking"] = Field(default_factory=list, description="細粒度標記")
...
class ExternalReference(BaseModel):
    ...
    hashes: Optional[Dict[str, str]] = Field(default=None, description="雜湊值")
    external_id: Optional[str] = Field(default=None, description="外部ID")
...
class AttackPattern(STIXDomainObject):
    ...
    description: Optional[str] = Field(default=None, description="攻擊模式描述")
    aliases: List[str] = Field(default_factory=list, description="別名列表")
    kill_chain_phases: List[KillChainPhase] = Field(default_factory=list, description="Kill Chain 階段")
    
    # MITRE ATT&CK 支援
    mitre_attack_id: Optional[str] = Field(default=None, description="MITRE ATT&CK ID")
    tactic: Optional[AttackTactic] = Field(default=None, description="MITRE ATT&CK 戰術")
    technique: Optional[AttackTechnique] = Field(default=None, description="MITRE ATT&CK 技術")
...
class Malware(STIXDomainObject):
    ...
    description: Optional[str] = Field(default=None, description="惡意軟體描述")
    ...
    operating_system_refs: List[str] = Field(default_factory=list, description="作業系統引用")
    architecture_execution_envs: List[str] = Field(default_factory=list, description="架構執行環境")
    implementation_languages: List[str] = Field(default_factory=list, description="實現語言")
...
class Indicator(STIXDomainObject):
    ...
    name: Optional[str] = Field(default=None, description="指標名稱")
    description: Optional[str] = Field(default=None, description="指標描述")
    pattern: str = Field(description="STIX 模式表達式")
    pattern_type: str = Field(default="stix", description="模式類型")
    pattern_version: Optional[str] = Field(default=None, description="模式版本")
    valid_from: datetime = Field(default_factory=lambda: datetime.now(UTC), description="有效起始時間")
    valid_until: Optional[datetime] = Field(default=None, description="有效結束時間")
    kill_chain_phases: List[KillChainPhase] = Field(default_factory=list, description="Kill Chain 階段")
    
    # IOC 相關欄位
    ioc_type: Optional[IOCType] = Field(default=None, description="IOC 類型")
    ioc_value: Optional[str] = Field(default=None, description="IOC 值")
...
class ThreatActor(STIXDomainObject):
    ...
    description: Optional[str] = Field(default=None, description="威脅行為者描述")
    threat_actor_types: List[str] = Field(description="威脅行為者類型")
    aliases: List[str] = Field(default_factory=list, description="別名列表")
    first_seen: Optional[datetime] = Field(default=None, description="首次發現時間")
    last_seen: Optional[datetime] = Field(default=None, description="最後活動時間")
    roles: List[str] = Field(default_factory=list, description="角色列表")
    goals: List[str] = Field(default_factory=list, description="目標列表")
    sophistication: Optional[str] = Field(default=None, description="複雜度")
    resource_level: Optional[str] = Field(default=None, description="資源水平")
    primary_motivation: Optional[str] = Field(default=None, description="主要動機")
    secondary_motivations: List[str] = Field(default_factory=list, description="次要動機")
    personal_motivations: List[str] = Field(default_factory=list, description="個人動機")
...
class IntrusionSet(STIXDomainObject):
    ...
    description: Optional[str] = Field(default=None, description="入侵集合描述")
    aliases: List[str] = Field(default_factory=list, description="別名列表")
    first_seen: Optional[datetime] = Field(default=None, description="首次發現時間")
    last_seen: Optional[datetime] = Field(default=None, description="最後活動時間")
    goals: List[str] = Field(default_factory=list, description="目標列表")
...
class Campaign(STIXDomainObject):
    ...
    description: Optional[str] = Field(default=None, description="攻擊活動描述")
    aliases: List[str] = Field(default_factory=list, description="別名列表")
    first_seen: Optional[datetime] = Field(default=None, description="首次發現時間")
    last_seen: Optional[datetime] = Field(default=None, description="最後活動時間")
    objective: Optional[str] = Field(default=None, description="目標")
...
class CourseOfAction(STIXDomainObject):
    ...
    description: Optional[str] = Field(default=None, description="行動方案描述")
    action_type: Optional[str] = Field(default=None, description="行動類型")
    os_execution_envs: List[str] = Field(default_factory=list, description="作業系統執行環境")
    action_bin: Optional[str] = Field(default=None, description="行動二進制")
    action_reference: Optional[ExternalReference] = Field(default=None, description="行動參考")
...
class Vulnerability(STIXDomainObject):
    ...
    description: Optional[str] = Field(default=None, description="漏洞描述")
    
    # CVE 相關欄位
    cve_id: Optional[str] = Field(default=None, description="CVE ID")
    cvss_score: Optional[float] = Field(default=None, ge=0.0, le=10.0, description="CVSS 分數")
    cvss_vector: Optional[str] = Field(default=None, description="CVSS 向量")
    
    # CWE 相關欄位
    cwe_id: Optional[str] = Field(default=None, description="CWE ID")
    
    # 額外屬性
    severity: Optional[str] = Field(default=None, description="嚴重程度")
    exploitability: Optional[str] = Field(default=None, description="可利用性")
...
class Report(STIXDomainObject):
    ...
    description: Optional[str] = Field(default=None, description="報告描述")
...
class Sighting(BaseModel):
    ...
    observed_data_refs: List[str] = Field(default_factory=list, description="觀察數據引用")
    where_sighted_refs: List[str] = Field(default_factory=list, description="目擊位置引用")
    first_seen: Optional[datetime] = Field(default=None, description="首次目擊時間")
    last_seen: Optional[datetime] = Field(default=None, description="最後目擊時間")
    count: Optional[int] = Field(default=None, ge=1, description="目擊次數")
    summary: bool = Field(default=False, description="是否為摘要")
    confidence: Optional[int] = Field(default=None, ge=0, le=100, description="置信度")
    revoked: bool = Field(default=False)
    external_references: List[ExternalReference] = Field(default_factory=list)
...
class Bundle(BaseModel):
    ...
    objects: List[Union[
        ...
        IntrusionSet, Campaign, CourseOfAction, Vulnerability,
        Tool, ObservedData, Report, Relationship, Sighting
...
class TAXIICollection(BaseModel):
    ...
    description: Optional[str] = Field(default=None, description="Collection 描述")
    alias: Optional[str] = Field(default=None, description="Collection 別名")
    can_read: bool = Field(default=True, description="是否可讀")
    can_write: bool = Field(default=False, description="是否可寫")
    media_types: List[str] = Field(default_factory=lambda: ["application/stix+json;version=2.1"], description="支援的媒體類型")
...
class TAXIIManifestEntry(BaseModel):
    ...
    date_added: Optional[datetime] = Field(default=None, description="新增日期")
    version: Optional[str] = Field(default=None, description="物件版本")
    media_type: Optional[str] = Field(default=None, description="媒體類型")
...
class TAXIIManifest(BaseModel):
    ...
    next: Optional[str] = Field(default=None, description="下一頁 URL")
...
class TAXIIErrorMessage(BaseModel):
    ...
    description: Optional[str] = Field(default=None, description="錯誤描述")
    error_id: Optional[str] = Field(default=None, description="錯誤 ID")
    ...
    external_details: Optional[str] = Field(default=None, description="外部詳細資訊")
...
class TAXIIStatus(BaseModel):
    ...
    request_timestamp: Optional[datetime] = Field(default=None, description="請求時間戳")
...
class ThreatIntelligenceReport(BaseModel):
    ...
    attack_patterns: List[AttackPattern] = Field(default_factory=list, description="攻擊模式列表")
    malware: List[Malware] = Field(default_factory=list, description="惡意軟體列表")
    threat_actors: List[ThreatActor] = Field(default_factory=list, description="威脅行為者列表")
    vulnerabilities: List[Vulnerability] = Field(default_factory=list, description="漏洞列表")
    relationships: List[Relationship] = Field(default_factory=list, description="關係列表")
    ...
    # TAXII 相關
    collection_id: Optional[str] = Field(default=None, description="TAXII Collection ID")
...
class IOCEnrichment(BaseModel):
    ...
    # 豐富化資訊
    reputation_score: Optional[int] = Field(default=None, ge=0, le=100, description="聲譽分數")
    is_malicious: Optional[bool] = Field(default=None, description="是否惡意")
    first_seen: Optional[datetime] = Field(default=None, description="首次發現")
    last_seen: Optional[datetime] = Field(default=None, description="最後發現")
    
    # 地理位置資訊（針對 IP）
    country: Optional[str] = Field(default=None, description="國家")
    city: Optional[str] = Field(default=None, description="城市")
    asn: Optional[str] = Field(default=None, description="ASN")
    ...
    # STIX 指標
    stix_indicator: Optional[Indicator] = Field(default=None, description="對應的 STIX 指標")
...
class LowValueVulnerabilityPattern(BaseModel):
    ...
    # STIX 對應
    attack_pattern: Optional[AttackPattern] = Field(default=None, description="對應的攻擊模式")
...
class BugBountyIntelligence(BaseModel):
    ...
    response_time_days: Optional[int] = Field(default=None, description="平均回應時間（天）")
    ...
    stix_bundle: Optional[Bundle] = Field(default=None, description="相關 STIX Bundle")
