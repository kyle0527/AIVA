...
class StatisticsCollector:
    ...
    def record_attack_attempt(self, attack_type: str, success: bool,
                              execution_time: float = 0.0, payload: str | None = None) -> None:
        """記錄攻擊嘗試"""
    ...
    def get_attack_stats(self, attack_type: str | None = None) -> dict:
        """獲取攻擊統計"""
...
def record_attack(attack_type: str, success: bool, execution_time: float = 0.0, payload: str | None = None):
    """便捷函數：記錄攻擊統計"""
