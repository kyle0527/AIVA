...
- [🎯 各引擎掃描模式總覽](#各引擎掃描模式總覽)
  - [📊 模式對照表](#模式對照表)
  - [🔄 模式切換詳細說明](#模式切換詳細說明)
    - [1. **Rust 引擎模式切換**](#1-rust-引擎模式切換)
    - [2. **Python 引擎策略切換**](#2-python-引擎策略切換)
    - [3. **TypeScript 引擎模式切換**](#3-typescript-引擎模式切換)
    - [4. **Go 引擎掃描器切換**](#4-go-引擎掃描器切換)
  - [🎯 協調器如何選擇模式](#協調器如何選擇模式)
  - [📋 模式選擇決策樹](#模式選擇決策樹)
  - [💡 最佳實踐建議](#最佳實踐建議)
- [📁 目錄結構](#目錄結構)
- [📄 重要檔案說明](#重要檔案說明)
  - [核心檔案](#核心檔案)
  - [文檔檔案](#文檔檔案)
  - [協調器檔案 (coordinators/)](#協調器檔案-coordinators)
  - [引擎檔案 (engines/)](#引擎檔案-engines)
  - [歸檔目錄](#歸檔目錄)
- [📊 系統統計](#系統統計)
- [🛠️ 開發指南](#開發指南)
  - [開發環境](#開發環境)
