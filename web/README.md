...
> **版本**: v1.0.0 | **狀態**: ✅ 生產就緒 | **最後更新**: 2025-12-17

現代化的 Web 管理控制台，提供直觀的用戶界面來管理 AIVA 安全掃描功能。

## 🔗 快速導航

- � [目錄總覽](./OVERVIEW.md) - Web 目錄完整說明
- 📖 [使用指南](#) - 本文件
- 🐛 [問題追蹤](./ISSUES_AND_TODO.md) - 已知問題和待辦事項  
- 📜 [合約指南](./contracts/README.md) - API 合約使用說明
- 🚀 [快速開始](#-快速開始) - 立即開始使用
...
- [📁 文件結構](#-文件結構)
- [🚀 快速開始](#-快速開始)
  - [1. 啟動 API 服務](#1-啟動-api-服務)
  - [2. 開啟 Web 界面](#2-開啟-web-界面)
  - [3. 訪問管理界面](#3-訪問管理界面)
- [📊 界面功能](#-界面功能)
  - [🏠 儀表板](#-儀表板)
  - [💎 安全掃描](#-安全掃描)
...
- [📊 使用統計](#-使用統計)
  ...
  - [商業價值](#商業價值)
- [🚀 未來規劃](#-未來規劃)
  - [短期計劃 (1-2 週)](#短期計劃-1-2-週)
  - [中期計劃 (1-2 月)](#中期計劃-1-2-月)
  - [長期計劃 (3-6 月)](#長期計劃-3-6-月)
- [🛠 故障排除](#-故障排除)
  - [常見問題](#常見問題)
  - [調試模式](#調試模式)
- [📞 技術支援](#-技術支援)
...
> 📋 **完整計劃和問題追蹤**: 請查看 [ISSUES_AND_TODO.md](./ISSUES_AND_TODO.md)

### 短期重點 (1-2 週)
- [ ] 掃描結果導出功能 (JSON/CSV/PDF)
- [ ] 批量掃描支援
- [ ] 掃描模板保存與管理
...
> 🐛 **已知問題和解決方案**: 請查看 [ISSUES_AND_TODO.md](./ISSUES_AND_TODO.md)

### 快速診斷

| 問題 | 可能原因 | 解決方案 |
|------|----------|----------|
| 無法連接 API | API 服務未啟動 | 檢查 `localhost:8000` 或修改 `apiBase` |
| 登入失敗 | 憑證錯誤 | 確認用戶名/密碼，檢查 API 狀態 |
| 掃描無法啟動 | 參數不完整 | 檢查必填欄位和 URL 格式 |
| 結果不顯示 | 掃描未完成 | 等待完成或檢查開發者工具 Console |
...
// 查看 API 請求
console.log(dashboard.lastRequest);
```
...
- [問題追蹤](./ISSUES_AND_TODO.md) - 已知問題和待辦事項
- [合約指南](./contracts/README.md) - API 合約使用說明
- [API 文檔](../api/README.md) - 後端 API 說明
