...
- [重組日期與目標](#重組日期與目標)
- [📊 現狀分析](#現狀分析)
  - [testing/ 目錄現狀](#testing-目錄現狀)
  - [scripts/ 目錄現狀](#scripts-目錄現狀)
- [🎯 重組方案](#重組方案)
  - [方案 A: 測試腳本歸位到服務模組](#方案-a-測試腳本歸位到服務模組)
  - [方案 B: 工具腳本歸位到服務模組](#方案-b-工具腳本歸位到服務模組)
  - [方案 C: 保留頂層測試和腳本目錄（推薦）](#方案-c-保留頂層測試和腳本目錄推薦)
- [📋 具體重組動作](#具體重組動作)
  - [階段 1: 清理 testing/ 目錄](#階段-1-清理-testing-目錄)
    - [1.1 歸檔老舊測試](#11-歸檔老舊測試)
    - [1.2 重組有價值的測試](#12-重組有價值的測試)
  - [階段 2: 清理 scripts/ 目錄](#階段-2-清理-scripts-目錄)
    - [2.1 歸檔無價值腳本](#21-歸檔無價值腳本)
    - [2.2 重組有價值的腳本](#22-重組有價值的腳本)
    - [2.3 簡化 misc/ 目錄](#23-簡化-misc-目錄)
- [📁 重組後的目錄結構](#重組後的目錄結構)
  - [testing/ 新結構](#testing-新結構)
  - [scripts/ 新結構](#scripts-新結構)
- [📊 重組統計](#重組統計)
  - [testing/ 目錄統計](#testing-目錄統計)
  - [scripts/ 目錄統計](#scripts-目錄統計)
- [✅ 執行步驟](#執行步驟)
  - [Step 1: 創建歸檔目錄](#step-1-創建歸檔目錄)
  - [Step 2: 移動 testing/ 中的老舊測試](#step-2-移動-testing-中的老舊測試)
  - [Step 3: 移動 scripts/ 中的老舊腳本](#step-3-移動-scripts-中的老舊腳本)
  - [Step 4: 更新所有 README](#step-4-更新所有-readme)
  - [Step 5: 驗證重組結果](#step-5-驗證重組結果)
- [🎯 預期效益](#預期效益)
  - [開發效益](#開發效益)
  - [團隊協作](#團隊協作)
- [🔄 後續更新: 工具遷移至 services/](#後續更新-工具遷移至-services)
  - [2025-11-22 實用工具遷移](#20251122-實用工具遷移)
