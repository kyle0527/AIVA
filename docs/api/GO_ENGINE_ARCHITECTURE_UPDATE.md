...
- [新架構方案](#新架構方案)
  - [調用方式](#調用方式)
  - [需要實現的命令行參數](#需要實現的命令行參數)
    - [SSRF Scanner (`cmd/ssrf-scanner/main.go`)](#ssrf-scanner-cmdssrfscannermaingo)
    - [SCA Scanner (`cmd/sca-scanner/main.go`)](#sca-scanner-cmdscascannermaingo)
    - [CSPM Scanner (`cmd/cspm-scanner/main.go`)](#cspm-scanner-cmdcspmscannermaingo)
- [輸出格式規範](#輸出格式規範)
- [待辦事項](#待辦事項)
  - [高優先級](#高優先級)
  - [中優先級](#中優先級)
