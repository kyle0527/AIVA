...
- [🛠️ aiva_common 修復規範](#aivacommon-修復規範)
  - [📌 必讀規範](#必讀規範)
  - [🎯 核心設計原則 (摘要)](#核心設計原則-摘要)
    - [1️⃣ 四層優先級原則](#1-四層優先級原則)
    - [2️⃣ 禁止重複定義](#2-禁止重複定義)
    - [3️⃣ 模組專屬枚舉判斷標準](#3-模組專屬枚舉判斷標準)
  - [🚫 常見錯誤與正確做法](#常見錯誤與正確做法)
    - [錯誤 1: 重複定義枚舉](#錯誤-1-重複定義枚舉)
    - [錯誤 2: 自創非標準概念](#錯誤-2-自創非標準概念)
    - [錯誤 3: 破壞性修改 Schema](#錯誤-3-破壞性修改-schema)
  - [📋 開發檢查清單](#開發檢查清單)
  - [🔗 相關文檔連結](#相關文檔連結)
  - [📊 修復規範版本](#修復規範版本)
