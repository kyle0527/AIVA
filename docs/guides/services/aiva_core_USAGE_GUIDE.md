...
- [✅ **系統狀態驗證**](#系統狀態驗證)
- [🧪 **測試驗證指南**](#測試驗證指南)
  - [**ModuleExplorer 測試** ✅ **已驗證通過**](#moduleexplorer-測試-已驗證通過)
  - [**相對導入修復** ✅ **已驗證通過**](#相對導入修復-已驗證通過)
  - [**測試最佳實踐**](#測試最佳實踐)
- [📋 **目錄**](#目錄)
- [🚀 **快速開始**](#快速開始)
  - [**基本初始化**](#基本初始化)
...
- [📊 **監控和分析**](#監控和分析)
  ...
  - [**執行軌跡分析**](#執行軌跡分析)
- [🎯 **實戰場景範例**](#實戰場景範例)
  - [**場景1: Bug Bounty自動化**](#場景1-bug-bounty自動化)
  - [**場景2: 紅隊演練協助**](#場景2-紅隊演練協助)
  - [**場景3: 持續安全監控**](#場景3-持續安全監控)
- [🔧 **故障排除**](#故障排除)
  - [**測試和導入問題** 🧪](#測試和導入問題)
    - [**1. ModuleExplorer 測試失敗**](#1-moduleexplorer-測試失敗)
    - [**2. 文件編碼錯誤**](#2-文件編碼錯誤)
    - [**3. 相對導入錯誤**](#3-相對導入錯誤)
    - [**4. 測試文件找不到**](#4-測試文件找不到)
  - [**開發環境問題**](#開發環境問題)
    - [**5. Python 環境檢查**](#5-python-環境檢查)
  - [**程式相關問題**](#程式相關問題)
    - [**1. 程式決策速度慢**](#1-程式決策速度慢)
    - [**2. 攻擊執行失敗**](#2-攻擊執行失敗)
    - [**3. 記憶體使用過高**](#3-記憶體使用過高)
...
> **🎯 目的**: AIVA Core 新一代程式化安全測試核心引擎使用教學  
> **👥 適用對象**: Bug Bounty獵人、安全研究員、程式開發者  
> **⚡ 核心特色**: 自動化處理 + 四種操作模式 + 自主執行  
...
**🔍 系統驗證結果**:
- 🧠 **程式化引擎**: 自動化主控制器、核心處理系統正常
- ⚡ **執行引擎**: 計劃執行器、攻擊編排器、任務轉換器正常  
- 📚 **知識系統**: 檢索引擎、知識庫管理、向量存储正常
- 🎓 **學習系統**: 模式訓練器、學習引擎、經驗管理系統正常
