...
- [📋 總覽](#-總覽)
- [🔍 階段一: AST 分析與流程圖生成](#-階段一-ast-分析與流程圖生成)
  - [核心功能](#核心功能)
  - [使用方式對照](#使用方式對照)
    - [Python 版本](#python-版本)
    - [Go 版本](#go-版本)
...
- [📊 階段二: 數據流分類與統計分析](#-階段二-數據流分類與統計分析)
  ...
  - [使用方式對照](#使用方式對照)
    ...
    - [Rust 版本](#rust-版本)
  - [輸出檔案對照](#輸出檔案對照)
- [🚀 階段三: 動態執行與文檔生成](#-階段三-動態執行與文檔生成)
  - [核心功能](#核心功能)
  - [使用方式對照](#使用方式對照)
    - [列出所有流程](#列出所有流程)
    - [執行特定流程](#執行特定流程)
    - [Dry Run 預覽](#dry-run-預覽)
    - [生成 Markdown 文檔](#生成-markdown-文檔)
    - [生成 JSON 資料庫](#生成-json-資料庫)
  - [輸出檔案對照](#輸出檔案對照)
- [🔄 完整工作流程範例](#-完整工作流程範例)
  - [場景: 分析混合語言專案](#場景-分析混合語言專案)
- [📝 功能差異說明](#-功能差異說明)
  - [執行模式](#執行模式)
  - [為何 Go/TS/Rust 是模擬執行？](#為何-gotsrust-是模擬執行)
  - [各語言的優勢](#各語言的優勢)
- [🎯 快速參考](#-快速參考)
  - [完整三階段命令 (Python)](#完整三階段命令-python)
  - [完整三階段命令 (Go)](#完整三階段命令-go)
  - [完整三階段命令 (TypeScript)](#完整三階段命令-typescript)
  - [完整三階段命令 (Rust)](#完整三階段命令-rust)
- [📦 檔案清單](#-檔案清單)
  - [Python 版本](#python-版本)
  - [Go 版本](#go-版本)
  - [TypeScript 版本](#typescript-版本)
