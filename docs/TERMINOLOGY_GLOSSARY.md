...
- [📚 術語對照表](#術語對照表)
  - [**容易混淆的術語**](#容易混淆的術語)
    - [**1. "探索" (Exploration)**](#1-探索-exploration)
    - [**2. "偵察" (Reconnaissance)**](#2-偵察-reconnaissance)
    - [**3. "分析" (Analysis)**](#3-分析-analysis)
    - [**4. "掃描" (Scanning)**](#4-掃描-scanning)
  - [**清晰命名規範**](#清晰命名規範)
    - [**對內操作 (Internal Operations)**](#對內操作-internal-operations)
    - [**對外操作 (External Operations)**](#對外操作-external-operations)
- [🔍 設計理念統一說明](#設計理念統一說明)
  - [**1. 三項基礎能力 (數據收集層)**](#1-三項基礎能力-數據收集層)
  - [**2. 雙重閉環整合 (優化決策層)**](#2-雙重閉環整合-優化決策層)
    - [**內部閉環** (Know Thyself)](#內部閉環-know-thyself)
    - [**外部閉環** (Learn from Battle)](#外部閉環-learn-from-battle)
  - [**3. 視覺化優先策略 (人機協作層)**](#3-視覺化優先策略-人機協作層)
- [📋 文檔更新檢查表](#文檔更新檢查表)
  - [**術語使用檢查**](#術語使用檢查)
  - [**設計理念檢查**](#設計理念檢查)
  - [**示例代碼檢查**](#示例代碼檢查)
