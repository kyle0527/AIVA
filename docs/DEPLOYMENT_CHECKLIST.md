...
- [📖 Integration 模組運作說明](#integration-模組運作說明)
  ...
  - [部署架構](#部署架構)
  - [關鍵設計決策](#關鍵設計決策)
  - [為什麼 localhost 連線不是問題？](#為什麼-localhost-連線不是問題)
  - [原本建議的問題](#原本建議的問題)
- [🔴 P0 - 發布前必須修復（嚴重）](#p0-發布前必須修復嚴重)
  - [1. 資料庫連線配置問題](#1-資料庫連線配置問題)
  - [2. 背景任務錯誤處理缺失](#2-背景任務錯誤處理缺失)
- [🟡 P2 - 建議修復（中等優先級）](#p2-建議修復中等優先級)
  - [3. SQLite 併發鎖死風險](#3-sqlite-併發鎖死風險)
- [📋 發布前檢查清單](#發布前檢查清單)
  - [資料庫連線配置](#資料庫連線配置)
  - [錯誤處理](#錯誤處理)
  - [測試驗證](#測試驗證)
...
- [🔍 驗證命令](#驗證命令)
  - [測試資料庫連線](#測試資料庫連線)
  - [測試背景任務錯誤處理](#測試背景任務錯誤處理)
- [📝 修復進度追蹤](#修復進度追蹤)
- [🎯 快速修復腳本（發布時執行）](#快速修復腳本發布時執行)
- [📚 相關文檔](#相關文檔)
  - [安裝與部署指南](#安裝與部署指南)
  - [開發環境指南](#開發環境指南)
  - [架構與進度](#架構與進度)
