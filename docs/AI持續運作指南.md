...
- [🎯 快速開始](#快速開始)
  - [方式 1: 雙擊啟動 (最簡單)](#方式-1-雙擊啟動-最簡單)
  - [方式 2: PowerShell 選單 (推薦)](#方式-2-powershell-選單-推薦)
  - [方式 3: 命令行直接啟動](#方式-3-命令行直接啟動)
- [📋 運作模式詳解](#運作模式詳解)
  - [1️⃣ API 服務模式 (推薦用於生產環境)](#1-api-服務模式-推薦用於生產環境)
  - [2️⃣ 後台監控模式 (推薦用於持續監控)](#2-後台監控模式-推薦用於持續監控)
  - [3️⃣ 交互式模式 (推薦用於手動測試)](#3-交互式模式-推薦用於手動測試)
  - [4️⃣ 守護進程模式 (推薦用於全功能運行)](#4-守護進程模式-推薦用於全功能運行)
  - [5️⃣ Windows 服務模式 (推薦用於開機自啟)](#5-windows-服務模式-推薦用於開機自啟)
- [🔧 進階配置](#進階配置)
  - [修改監聽地址](#修改監聽地址)
  - [修改日誌級別](#修改日誌級別)
  - [多目標監控](#多目標監控)
...
- [📊 監控與日誌](#監控與日誌)
  ...
  - [監控服務狀態](#監控服務狀態)
- [🛠️ 故障排除](#故障排除)
  - [問題 1: 端口已被占用](#問題-1-端口已被占用)
  - [問題 2: Python 模組導入失敗](#問題-2-python-模組導入失敗)
  - [問題 3: 服務無法啟動](#問題-3-服務無法啟動)
  - [問題 4: 引擎不可用](#問題-4-引擎不可用)
- [📈 性能優化](#性能優化)
  - [1. 增加並發數](#1-增加並發數)
  - [2. 調整掃描策略](#2-調整掃描策略)
  - [3. 資源限制](#3-資源限制)
