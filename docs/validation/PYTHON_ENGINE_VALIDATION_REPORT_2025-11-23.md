...
- [📋 驗證概要](#驗證概要)
- [🔴 發現的錯誤](#發現的錯誤)
  - [錯誤 #1: scan_id 格式錯誤 (Lines 30-42)](#錯誤-1-scan-id-格式錯誤-lines-30-42)
  - [錯誤 #2: API 方法名錯誤 (Lines 88-115)](#錯誤-2-api-方法名錯誤-lines-88-115)
  - [錯誤 #3: 參數接口不匹配 (Lines 90-115)](#錯誤-3-參數接口不匹配-lines-90-115)
  - [錯誤 #4: 返回類型不匹配 (Lines 300-320)](#錯誤-4-返回類型不匹配-lines-300-320)
- [⚠️ 未驗證章節](#未驗證章節)
- [📊 驗證統計](#驗證統計)
  - [代碼示例檢查](#代碼示例檢查)
  - [錯誤分類](#錯誤分類)
