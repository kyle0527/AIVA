...
- [🚀 立即開始開發](#立即開始開發)
  - [1. 環境驗證 (2分鐘)](#1-環境驗證-2分鐘)
  - [2. 開發前準備 (5分鐘)](#2-開發前準備-5分鐘)
  - [3. 創建開發分支](#3-創建開發分支)
- [📂 開發目錄結構](#開發目錄結構)
- [💻 Week 1 立即開始 - AI攻擊計畫映射器](#week-1-立即開始-ai攻擊計畫映射器)
  - [Step 1: 建立測試框架 (30分鐘)](#step-1-建立測試框架-30分鐘)
  - [Step 2: 開始核心開發 (第一個功能)](#step-2-開始核心開發-第一個功能)
  - [Step 3: 執行第一次測試](#step-3-執行第一次測試)
- [⚡ 開發工具配置](#開發工具配置)
  - [IDE 性能優化設定](#ide-性能優化設定)
- [🔄 每日開發流程](#每日開發流程)
  - [每日開始 (5分鐘)](#每日開始-5分鐘)
  - [每日結束 (10分鐘)](#每日結束-10分鐘)
- [🎯 快速啟動命令](#快速啟動命令)
