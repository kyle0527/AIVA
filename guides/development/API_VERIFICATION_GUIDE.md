...
- [架構設計](#架構設計)
  ...
  - [驗證流程](#驗證流程)
- [驗證狀態](#驗證狀態)
  - [VerificationStatus 枚舉](#verificationstatus-枚舉)
- [支持的服務](#支持的服務)
  - [已實現驗證 (10 個服務)](#已實現驗證-10-個服務)
  - [驗證示例](#驗證示例)
    - [GitHub Token 驗證](#github-token-驗證)
    - [Slack Token 驗證](#slack-token-驗證)
- [緩存機制](#緩存機制)
  - [目的](#目的)
  - [實現細節](#實現細節)
  - [緩存策略](#緩存策略)
