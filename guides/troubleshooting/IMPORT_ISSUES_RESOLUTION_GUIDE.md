...
- [🎯 **指南目標**](#指南目標)
- [🔍 **問題診斷流程**](#問題診斷流程)
  - [**Step 1: 識別問題類型**](#step-1-識別問題類型)
  - [**Step 2: 快速診斷命令**](#step-2-快速診斷命令)
- [⚡ **Services 導入路徑修復**](#services-導入路徑修復)
  - [**問題類型**: 錯誤的服務間導入路徑](#問題類型-錯誤的服務間導入路徑)
    - [**症狀**](#症狀)
    - [**修復方法**](#修復方法)
    - [**架構規則**](#架構規則)
- [🔧 **Optional Dependencies 修復**](#optional-dependencies-修復)
  - [**問題類型**: 可選依賴缺失導致系統崩潰](#問題類型-可選依賴缺失導致系統崩潰)
    - [**症狀**](#症狀-1)
    - [**修復方法 - 使用統一框架**](#修復方法-使用統一框架)
    - [**Mock 實現範例**](#mock-實現範例)
- [🔄 **循環導入修復**](#循環導入修復)
  - [**問題類型**: 模組間相互導入造成循環依賴](#問題類型-模組間相互導入造成循環依賴)
    - [**診斷方法**](#診斷方法)
    - [**修復策略**](#修復策略)
- [📦 **常見依賴修復配方**](#常見依賴修復配方)
  - [**Plotly 相關**](#plotly-相關)
  - [**Pandas 相關**](#pandas-相關)
  - [**Scikit-learn 相關**](#scikitlearn-相關)
  - [**Deep Learning 相關**](#deep-learning-相關)
- [🛠️ **系統性修復工具**](#系統性修復工具)
  - [**批量掃描腳本**](#批量掃描腳本)
  - [**自動修復腳本**](#自動修復腳本)
- [✅ **修復後驗證**](#修復後驗證)
