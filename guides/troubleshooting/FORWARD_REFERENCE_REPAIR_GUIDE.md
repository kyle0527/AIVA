...
- [📋 概述](#概述)
  - [🎯 核心原則](#核心原則)
- [🔍 向前引用問題類型](#向前引用問題類型)
  - [類型 1: 基本前向引用錯誤](#類型-1-基本前向引用錯誤)
  - [類型 2: 複雜泛型中的前向引用](#類型-2-複雜泛型中的前向引用)
  - [類型 3: 循環引用](#類型-3-循環引用)
  - [類型 4: 複雜類型推導錯誤](#類型-4-複雜類型推導錯誤)
- [🌍 跨語言適用性](#跨語言適用性)
  - [支援語言範圍](#支援語言範圍)
  - [跨語言問題模式對應](#跨語言問題模式對應)
  - [通用修復原則](#通用修復原則)
- [🛠️ 發現工具與方法](#發現工具與方法)
  - [1. Pylance MCP 工具（推薦）](#1-pylance-mcp-工具推薦)
    - [語法錯誤檢測](#語法錯誤檢測)
    - [導入分析](#導入分析)
    - [自動重構](#自動重構)
  - [2. SonarQube 分析工具](#2-sonarqube-分析工具)
  - [3. 傳統工具](#3-傳統工具)
    - [get_errors 全面分析](#geterrors-全面分析)
    - [grep_search 精確搜索](#grepsearch-精確搜索)
    - [semantic_search 語義搜索](#semanticsearch-語義搜索)
- [⚡ 系統化修復流程](#系統化修復流程)
  - [階段一：全面發現與分析](#階段一全面發現與分析)
    - [1.1 使用 Pylance 進行全面語法檢查](#11-使用-pylance-進行全面語法檢查)
    - [1.2 使用 get_errors 獲取編譯錯誤](#12-使用-geterrors-獲取編譯錯誤)
    - [1.3 分析錯誤模式](#13-分析錯誤模式)
  - [階段二：個別修復複雜問題](#階段二個別修復複雜問題)
    - [2.1 跨語言問題識別與分類](#21-跨語言問題識別與分類)
    - [2.2 複雜類型推導修復（基於 Python 官方最佳實踐）](#22-複雜類型推導修復基於-python-官方最佳實踐)
    - [2.3 語言特定問題修復](#23-語言特定問題修復)
      - [Rust 特定修復策略](#rust-特定修復策略)
      - [Go 特定修復策略](#go-特定修復策略)
      - [TypeScript 最佳實踐驗證](#typescript-最佳實踐驗證)
    - [2.4 循環引用重構](#24-循環引用重構)
    - [2.2 解決導入順序問題](#22-解決導入順序問題)
  - [階段三：批量處理前的驗證](#階段三批量處理前的驗證)
    - [3.1 模式識別和驗證](#31-模式識別和驗證)
    - [3.2 測試修復效果](#32-測試修復效果)
  - [階段四：安全批量處理](#階段四安全批量處理)
    - [4.1 單文件批量處理](#41-單文件批量處理)
    - [4.2 漸進式批量處理](#42-漸進式批量處理)
- [🧪 驗證與測試](#驗證與測試)
  - [1. 立即驗證](#1-立即驗證)
  - [2. 完整性測試](#2-完整性測試)
- [📋 修復檢查清單](#修復檢查清單)
  ...
  - [修復後檢查](#修復後檢查)
- [🚨 常見陷阱與解決方案](#常見陷阱與解決方案)
  - [陷阱 1: 過度批量處理](#陷阱-1-過度批量處理)
  - [陷阱 2: 忽略循環引用](#陷阱-2-忽略循環引用)
  - [陷阱 3: 破壞現有功能](#陷阱-3-破壞現有功能)
- [📊 工具能力對比](#工具能力對比)
- [🔗 相關資源](#相關資源)
  - [官方文檔](#官方文檔)
  - [AIVA 相關](#aiva-相關)
