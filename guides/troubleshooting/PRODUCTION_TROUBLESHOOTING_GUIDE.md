...
- [🚨 緊急故障快速診斷](#-緊急故障快速診斷)
  - [30 秒健康檢查](#30-秒健康檢查)
- [🔧 常見問題與解決方案](#-常見問題與解決方案)
  - [問題 1: 資料庫連線失敗](#問題-1-資料庫連線失敗--高頻)
  - [問題 2: Playwright 瀏覽器啟動失敗](#問題-2-playwright-瀏覽器啟動失敗--常見)
  - [問題 3: 記憶體不足 (OOM)](#問題-3-記憶體不足-oom--常見)
  - [問題 4: TypeScript Engine 無法啟動](#問題-4-typescript-engine-無法啟動--常見)
  - [問題 5: Go 模組執行失敗](#問題-5-go-模組執行失敗--偶爾)
  - [問題 6: 背景任務無聲停止](#問題-6-背景任務無聲停止--隱蔽)
  - [問題 7: SQLite 資料庫鎖定](#問題-7-sqlite-資料庫鎖定--偶爾)
  - [問題 8: Python 套件衝突](#問題-8-python-套件衝突--偶爾)
  - [問題 9: Redis 連線逾時](#問題-9-redis-連線逾時--偶爾)
- [🔍 日誌分析](#-日誌分析)
  - [關鍵日誌位置](#關鍵日誌位置)
  - [常見錯誤模式](#常見錯誤模式)
- [📊 效能監控](#-效能監控)
