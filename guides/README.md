...
- [🏗️ 指南架構總覽](#指南架構總覽)
  - [🎯 **AIVA v2.1.1 系統架構** (2025-11-25)](#aiva-v211-系統架構-20251125)
    ...
    - [**五大程式模組架構**](#五大程式模組架構)
- [📖 指南分類目錄](#指南分類目錄)
  - [🏆 **核心綜合指南** (頂級參考)](#核心綜合指南-頂級參考)
  - [🔗 **架構與設計文檔**](#架構與設計文檔)
  - [🛠️ **實用工具**](#實用工具)
  - [🛠️ **開發相關指南** (`development/`)](#開發相關指南-development)
  - [🏗️ **架構設計指南** (`architecture/`)](#架構設計指南-architecture) - 🆕 2026-01-11 更新
  - [⚙️ **模組專業指南** (`modules/`) - 五大程式模組](#模組專業指南-modules-五大程式模組)
    - [🎯 **Core 模組** - AI 引擎核心](#core-模組-ai-引擎核心)
    - [⚙️ **Features 模組** - 多語言業務功能](#features-模組-多語言業務功能)
    - [🔍 **Scan 模組** - 掃描與偵測](#scan-模組-掃描與偵測)
    - [🔗 **Integration 模組** - 整合與協調](#integration-模組-整合與協調)
    - [🏗️ **Common 模組** - 共用基礎設施](#common-模組-共用基礎設施)
    - [📋 **功能模組需求文件** (2025-11-06 完成)](#功能模組需求文件-20251106-完成)
    - [📋 **模組專用指南**](#模組專用指南)
  - [🚀 **部署運維指南** (`deployment/`)](#部署運維指南-deployment)
  - [🔧 **疑難排解指南** (`troubleshooting/`)](#疑難排解指南-troubleshooting)
  - [🤖 **AI 與功能手冊**](#ai-與功能手冊)
  - [🛠️ **工具與測試手冊**](#工具與測試手冊)
- [🎯 **使用建議與學習路徑**](#使用建議與學習路徑)
  - [🧠 **AI 核心設計理念** (必讀)](#ai-核心設計理念-必讀)
  - [📚 **新手入門路徑** (按順序學習)](#新手入門路徑-按順序學習)
  - [🔧 **功能模組開發者路徑**](#功能模組開發者路徑)
  - [💻 **傳統開發者專業路徑**](#傳統開發者專業路徑)
  - [🏭 **運維部署路徑**](#運維部署路徑)
  - [🤖 **AI 功能專家路徑**](#ai-功能專家路徑)
...
### 🎯 **AIVA v2.1.2 系統架構** (2026-01-10 檢查)

#### **五大核心模組**
```
🏗️ AIVA 服務架構（五大核心模組）
├── 🤖 Core          # AI 驅動核心引擎 (cognitive_core, internal_exploration, task_planning, core_capabilities, service_backbone)
├── 🔗 Common        # 共享基礎設施 (100+ 模組)
├── 🎯 Features      # 多語言安全功能 (17+ 模組)
├── 🔄 Integration   # 企業級整合中樞
└── 🔍 Scan          # 多語言統一掃描引擎
```
...
- **Core 內五大子模組**: cognitive_core, internal_exploration, task_planning, core_capabilities, service_backbone
...
### 🏗️ **架構設計指南** (`architecture/`) - 🆕 2026-01-11 更新

> **🎯 核心架構方案**: 已完成 AI 排序器方案整合，所有架構文件已統一移至 `architecture/` 目錄  
> **📊 文件狀態**: 9 個架構指南，包含 1 個核心方案 ⭐ + 3 個雙閉環指南 🔑 + 5 個參考指南 📚  
> **🔍 重複檢查**: ✅ 已完成，無衝突內容

| 指南類型 | 文檔路徑 | 技術重點 | 狀態 |
|---------|----------|----------|------|
| **📐 架構指南索引** | [`architecture/架構指南索引.md`](architecture/架構指南索引.md) | 📑 總覽、學習路徑、重複分析 | ✅ **必讀** 🎯 |
| **⭐ AI 排序器實施指南** | [`architecture/AI排序器實施指南.md`](architecture/AI排序器實施指南.md) | 🤖 核心方案（評分 9.15/10） | ✅ **核心方案** ⭐ |
| ** 雙閉環設計指南** | [`../DUAL_LOOP_DESIGN_GUIDE.md`](../DUAL_LOOP_DESIGN_GUIDE.md) | 🔄 內外閉環自我優化 | ✅ **核心參考** 🔑 |
| **🔑 雙閉環可行性分析** | [`architecture/雙閉環可行性分析指南.md`](architecture/雙閉環可行性分析指南.md) | 📊 可行性評分 4.9/5.0 | ✅ **核心參考** 🔑 |
| **🔑 雙閉環數據協調** | [`architecture/雙閉環數據協調指南.md`](architecture/雙閉環數據協調指南.md) | 📋 OWASP/SARIF/CVE 標準 | ✅ **核心參考** 🔑 |
| **📚 雙 CLI 架構設計** | [`architecture/雙CLI架構設計指南.md`](architecture/雙CLI架構設計指南.md) | 🔌 subprocess + JSON 標準 | ✅ **參考用** 📚 |
| **📚 跨語言 CLI 設計** | [`architecture/跨語言CLI設計指南.md`](architecture/跨語言CLI設計指南.md) | 🌐 JSON 合約標準 | ✅ **參考用** 📚 |
| **⏸️ CLI 架構重構** | [`architecture/CLI架構重構指南.md`](architecture/CLI架構重構指南.md) | 🔧 移除冗餘層（已完成） | ✅ **部分完成** ⏸️ |
| **📚 服務架構分析** | [`architecture/服務架構分析指南.md`](architecture/服務架構分析指南.md) | 🏗️ 五大核心模組詳解 | ✅ **參考用** 📚 |
| **✅ 架構綜合評估** | [`architecture/架構綜合評估指南.md`](architecture/架構綜合評估指南.md) | 📊 8+ 文件綜合分析 | ✅ **決策依據** ✅ |

**🚀 快速開始**:
1. 閱讀 [架構指南索引](architecture/架構指南索引.md) - 了解整體架構（10 分鐘）
2. 精讀 [AI 排序器實施指南](architecture/AI排序器實施指南.md) - 核心方案（30 分鐘）
3. 參考 [雙閉環設計指南](../DUAL_LOOP_DESIGN_GUIDE.md) - 自我優化機制（15 分鐘）

---

#### **📊 v2.1.2 Schema 與數據合約架構**
...
---
### 📚 **新手入門路徑** (按順序學習)
1. **AIVA 系統架構文檔** ([`../README.md`](../README.md)) - 了解 v2.1.2 架構與五大核心模組（生產就緒）
