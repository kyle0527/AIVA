...
- [🏗️ **系統架構**](#系統架構)
  - [**整體架構圖**](#整體架構圖)
  - [**核心組件**](#核心組件)
    - [1. **智能修復引擎** (`smart_repair_engine.py`)](#1-智能修復引擎-smartrepairenginepy)
    - [2. **安全邊界檢查** (新增)](#2-安全邊界檢查-新增)
    - [3. **智能診斷系統** (`mermaid_diagnostic_system.py`)](#3-智能診斷系統-mermaiddiagnosticsystempy)
- [🛡️ **安全修復邊界**](#安全修復邊界)
  - [**修復安全等級定義**](#修復安全等級定義)
    - [**✅ Level 1: 始終安全 (Always Safe)**](#level-1-始終安全-always-safe)
    - [**⚠️ Level 2: 需要驗證 (Needs Validation)**](#level-2-需要驗證-needs-validation)
    - [**❌ Level 3: 上下文依賴 (Context Dependent)**](#level-3-上下文依賴-context-dependent)
    - [**🚫 Level 4: 絕不修復 (Never Repair)**](#level-4-絕不修復-never-repair)
  - [**安全修復決策流程**](#安全修復決策流程)
- [🔧 **使用指南**](#使用指南)
  - [**1. 快速開始**](#1-快速開始)
    - [基本使用](#基本使用)
  ...
  - [**3. 高級配置**](#3-高級配置)
    ...
    - [配置安全邊界](#配置安全邊界)
- [📊 **實戰案例分析**](#實戰案例分析)
  - [**案例1: MERMAID_DIAGRAM_FIX_REPORT.md 修復實戰**](#案例1-mermaiddiagramfixreportmd-修復實戰)
    - [問題描述](#問題描述)
    - [修復過程](#修復過程)
    - [經驗教訓](#經驗教訓)
...
- [🔍 **錯誤檢測機制**](#錯誤檢測機制)
  - [**檢測算法架構**](#檢測算法架構)
    ...
    - [2. **語法錯誤檢測**](#2-語法錯誤檢測)
  - [**錯誤分類系統**](#錯誤分類系統)
    - [**Critical 級別** (必須修復)](#critical-級別-必須修復)
    - [**Error 級別** (應該修復)](#error-級別-應該修復)
    - [**Warning 級別** (建議修復)](#warning-級別-建議修復)
    - [**Optimization 級別** (可選修復)](#optimization-級別-可選修復)
- [⚙️ **修復規則庫**](#修復規則庫)
  - [**規則定義結構**](#規則定義結構)
  - [**核心修復規則**](#核心修復規則)
    - [1. **嵌套塊修復規則**](#1-嵌套塊修復規則)
    - [2. **空格修復規則**](#2-空格修復規則)
    - [3. **未關閉塊修復規則**](#3-未關閉塊修復規則)
  - [**規則管理系統**](#規則管理系統)
    - [動態加載和保存](#動態加載和保存)
    - [規則統計和優化](#規則統計和優化)
- [📈 **持續學習系統**](#持續學習系統)
...
- [🚀 **最佳實踐**](#最佳實踐)
  - [**開發環境實踐**](#開發環境實踐)
    - [1. **集成到開發工作流**](#1-集成到開發工作流)
    - [2. **VS Code 集成**](#2-vs-code-集成)
    - [3. **實時驗證**](#3-實時驗證)
  - [**生產環境實踐**](#生產環境實踐)
...
- [❗ **故障排除**](#故障排除)
  - [**常見問題和解決方案**](#常見問題和解決方案)
    - [**問題1: 智能診斷系統無法啟動**](#問題1-智能診斷系統無法啟動)
    - [**問題2: 修復規則不生效**](#問題2-修復規則不生效)
    - [**問題3: 修復結果不符合預期**](#問題3-修復結果不符合預期)
    - [**問題4: 性能問題**](#問題4-性能問題)
  - [**調試工具**](#調試工具)
    - [**診斷模式**](#診斷模式)
    - [**規則測試**](#規則測試)
