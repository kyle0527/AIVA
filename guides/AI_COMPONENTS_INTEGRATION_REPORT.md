...
- [📋 AI 組件詳細說明文檔分析](#ai-組件詳細說明文檔分析)
  ...
  - [🎯 文檔價值評估](#文檔價值評估)
- [🔗 指南系統整合結果](#指南系統整合結果)
  - [✅ 在 AI 引擎指南中的整合](#在-ai-引擎指南中的整合)
  - [✅ 在指南中心的整合](#在指南中心的整合)
- [📝 發現的文檔特性](#發現的文檔特性)
  - [🎯 AI 組件詳細說明的指南特性](#ai-組件詳細說明的指南特性)
  - [💡 建議](#建議)
- [🔍 指南系統中的 AI 組件相關內容](#指南系統中的-ai-組件相關內容)
  - [📚 現有 AI 相關指南](#現有-ai-相關指南)
  - [🔗 建立的引用關係](#建立的引用關係)
- [🎉 整合完成效果](#整合完成效果)
  - [✅ 用戶體驗提升](#用戶體驗提升)
  - [✅ 文檔系統改善](#文檔系統改善)
...
**更新日期**: 2025-11-15 (添加 AI 自我優化設計理念)  
**狀態**: ✅ 完成  
...
AIVA 的 22 個 AI 組件支持**雙重閉環自我優化**設計:

#### **內部閉環 (Know Thyself)** - 系統自我認知
- **探索功能 (對內)**: `SystemSelfExplorer` - AIVA 系統自我診斷與內省
  - 掃描五大模組健康狀態
  - 分析系統組件依賴關係
  - 生成系統能力報告
...
⚠️ **術語規範** (參見 [`../TERMINOLOGY_GLOSSARY.md`](../TERMINOLOGY_GLOSSARY.md)):
- **對內操作**: `system_self_*`, `internal_*`, `introspection_*`
- **對外操作**: `target_*`, `external_*`, `reconnaissance_*`, `attack_*`
