...
> **⚠️ 文檔狀態**: 🔑 **核心參考 - 與 AI 排序器方案完美互補**  
> **重要性**: ⭐⭐⭐⭐⭐ 雙閉環是 AI 自我優化的核心機制  
> **整合方向**: AI 排序器方案增強了雙閉環的決策能力，請同時參考 [SIMPLIFIED_DUAL_CLI_DESIGN.md](../docs/05_implementation_guides/SIMPLIFIED_DUAL_CLI_DESIGN.md)  
> **下一步**: 實施 AI 排序器時，整合內部閉環（Know Thyself）與外部閉環（Learn from Battle）

**設計日期**: 2025年11月15日  
**最後更新**: 2025年11月28日  
**檢查日期**: 2026年1月10日  
**核心理念**: 內省 + 實戰 → 自我優化 → 視覺化驗證  
**狀態**: ✅ 設計參考基準 | ✅ 模擬代碼已修復 | 🟢 可行性已驗證
...
- [🔄 雙重閉環機制](#雙重閉環機制)
  - [外部閉環 (對外掃描) - 已整合多引擎工作流程](#外部閉環-對外掃描-已整合多引擎工作流程)
  - [內部閉環 (對內探索)](#內部閉環-對內探索)
- [📊 AI 能力規劃結構](#ai-能力規劃結構)
  - [**階段 1: 基礎三項能力** (數據收集層)](#階段-1-基礎三項能力-數據收集層)
    - [**1.1 探索功能 (對內 - Introspection)**](#11-探索功能-對內-introspection)
    - [**1.2 靜態分析功能 (代碼品質評估)**](#12-靜態分析功能-代碼品質評估)
    - [**1.3 RAG 知識增強功能**](#13-rag-知識增強功能)
  - [**階段 2: 雙重閉環反饋** (數據整合層)](#階段-2-雙重閉環反饋-數據整合層)
    - [**2.1 內部閉環 (Know Thyself)**](#21-內部閉環-know-thyself)
    - [**2.2 外部閉環 (Learn from Battle)**](#22-外部閉環-learn-from-battle)
  - [**階段 3: AI 自我優化決策** (優化執行層)](#階段-3-ai-自我優化決策-優化執行層)
    - [**3.1 整合雙重閉環數據**](#31-整合雙重閉環數據)
    - [**3.2 視覺化優化方案** (人工審核介面)](#32-視覺化優化方案-人工審核介面)
    - [**3.3 執行優化**](#33-執行優化)
- [🔄 完整雙重閉環流程](#完整雙重閉環流程)
  - [**週期性執行**](#週期性執行)
- [🎯 設計亮點總結](#設計亮點總結)
  - [**1. 雙重閉環設計**](#1-雙重閉環設計)
  - [**2. 三項基礎能力的協同**](#2-三項基礎能力的協同)
  - [**3. 視覺化人機協作**](#3-視覺化人機協作)
  - [**4. 持續進化機制**](#4-持續進化機制)
- [📈 預期效果](#預期效果)
  - [**短期效果** (1-3 個月)](#短期效果-13-個月)
  - [**中期效果** (3-6 個月)](#中期效果-36-個月)
  - [**長期效果** (6-12 個月)](#長期效果-612-個月)
- [🚀 實施路線圖](#實施路線圖)
  - [**Phase 1: 基礎建設** (當前)](#phase-1-基礎建設-當前)
  - [**Phase 2: 閉環構建** (下一步)](#phase-2-閉環構建-下一步)
  - [**Phase 3: 優化執行** (未來)](#phase-3-優化執行-未來)
  - [**Phase 4: 持續進化** (長期)](#phase-4-持續進化-長期)
- [📊 引擎資料流與參數提取](#引擎資料流與參數提取)
  - [Python 引擎與參數提取的關係](#python-引擎與參數提取的關係)
    - [提取邏輯](#提取邏輯)
    - [示例對比](#示例對比)
  - [各引擎資料流對比](#各引擎資料流對比)
  - [參數提取策略](#參數提取策略)
