...
- [🔄 整合執行步驟](#整合執行步驟)
  - [Phase 1: 移動高價值指南 (優先)](#phase-1-移動高價值指南-優先)
  - [Phase 2: 內容整合和去重](#phase-2-內容整合和去重)
  - [Phase 3: 更新索引和導航](#phase-3-更新索引和導航)
...
- [📊 整合方案總覽](#-整合方案總覽)
- [🟢 建議移入 guides/ 的指南](#-建議移入-guides-的指南)
  - [→ guides/development/](#-guidesdevelopment)
  - [→ guides/architecture/](#-guidesarchitecture)
  - [→ guides/troubleshooting/](#-guidestroubleshooting)
- [🟡 建議保留在原位置的指南](#-建議保留在原位置的指南)
- [🔴 建議歸檔的指南](#-建議歸檔的指南)
- [📋 執行步驟](#-執行步驟)
- [🎯 預期效果](#-預期效果)
