...
- [🎯 概覽](#概覽)
  - [📦 映像檔類型](#映像檔類型)
- [🚀 快速建立](#快速建立)
  - [1. 建立所有映像檔（一鍵建立）](#1-建立所有映像檔一鍵建立)
  - [2. 個別建立映像檔](#2-個別建立映像檔)
- [🔧 建立選項與優化](#建立選項與優化)
  - [高級建立參數](#高級建立參數)
  - [環境變數自訂](#環境變數自訂)
- [📁 映像檔內容說明](#映像檔內容說明)
  - [核心服務映像檔 (`aiva-core`)](#核心服務映像檔-aiva-core)
  - [功能組件映像檔 (`aiva-component`)](#功能組件映像檔-aiva-component)
- [🔍 映像檔驗證](#映像檔驗證)
  - [建立完成後驗證](#建立完成後驗證)
  - [映像檔大小優化驗證](#映像檔大小優化驗證)
- [🚢 部署與運行](#部署與運行)
  - [使用 Docker Compose 部署](#使用-docker-compose-部署)
  - [使用 Kubernetes 部署](#使用-kubernetes-部署)
  - [使用 Helm 部署](#使用-helm-部署)
- [🔧 故障排除](#故障排除)
  - [常見建立問題](#常見建立問題)
  - [性能優化建議](#性能優化建議)
- [📊 統一環境變數](#統一環境變數)
- [🔄 CI/CD 整合](#cicd-整合)
  - [GitHub Actions 建立範例](#github-actions-建立範例)
- [📚 相關資源](#相關資源)
- [🎯 最佳實踐總結](#最佳實踐總結)
- [📞 支援](#支援)
- [🔗 相關資源](#相關資源)
