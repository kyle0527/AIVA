...
- [🎯 概述](#概述)
  - [✨ 核心特色](#核心特色)
- [📋 Schema 分類](#schema-分類)
  - [📊 當前 Schema 統計](#當前-schema-統計)
  - [🗂️ Schema 分類詳情](#schema-分類詳情)
- [🚀 快速開始](#快速開始)
  - [1. 基本使用](#1-基本使用)
  - [2. 跨語言代碼生成](#2-跨語言代碼生成)
  - [3. AI 友好信息獲取](#3-ai-友好信息獲取)
- [📝 詳細使用範例](#詳細使用範例)
  - [🔄 異步工具模組 (async_utils)](#異步工具模組-asyncutils)
    - [AsyncTaskConfig 使用範例](#asynctaskconfig-使用範例)
  - [🔌 插件管理模組 (plugins)](#插件管理模組-plugins)
    - [PluginManifest 使用範例](#pluginmanifest-使用範例)
  - [🖥️ CLI 界面模組 (cli)](#cli-界面模組-cli)
    - [CLICommand 使用範例](#clicommand-使用範例)
- [🛠️ 開發工具](#開發工具)
  - [1. Schema 代碼生成器](#1-schema-代碼生成器)
  - [2. 跨語言一致性驗證](#2-跨語言一致性驗證)
  - [3. AI 組件接口測試](#3-ai-組件接口測試)
- [🔍 AI 組件操作指南](#ai-組件操作指南)
  - [AI 如何使用跨語言 Schema](#ai-如何使用跨語言-schema)
    - [1. 理解 Schema 結構](#1-理解-schema-結構)
    - [2. 動態代碼生成](#2-動態代碼生成)
    - [3. 類型轉換助手](#3-類型轉換助手)
- [🔧 擴展和自定義](#擴展和自定義)
  - [添加新的 Schema](#添加新的-schema)
  - [添加新的語言支援](#添加新的語言支援)
- [🚨 常見問題和故障排除](#常見問題和故障排除)
  - [Q1: 代碼生成失敗](#q1-代碼生成失敗)
- [跨語言環境配置](#跨語言環境配置)
  - [研發階段（自動配置）](#研發階段自動配置)
  - [生產環境（部署時才需要）](#生產環境部署時才需要)
  - [Q2: 跨語言類型不一致](#q2-跨語言類型不一致)
  - [Q3: AI 組件無法理解 Schema](#q3-ai-組件無法理解-schema)
  - [Q4: 新增 Schema 後編譯錯誤](#q4-新增-schema-後編譯錯誤)
- [📈 性能和最佳實踐](#性能和最佳實踐)
  - [1. Schema 設計原則](#1-schema-設計原則)
  - [2. 代碼生成最佳實踐](#2-代碼生成最佳實踐)
  - [3. AI 組件使用建議](#3-ai-組件使用建議)
- [📚 相關資源](#相關資源)
- [🎯 總結](#總結)
- [🔗 相關資源](#相關資源-1)
  - [架構指南](#架構指南)
