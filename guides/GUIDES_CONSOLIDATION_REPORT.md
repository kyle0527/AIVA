...
- [📦 保留在 services/ 的技術文檔 (8個)](#保留在-services-的技術文檔-8個)
  ...
  - [存檔文檔 (1個)](#存檔文檔-1個)
- [📄 保留在 docs/user_guides/ 的使用者手冊 (7個)](#保留在-docsuser-guides-的使用者手冊-7個)
  - [00_general (2個)](#00-general-2個)
  - [01_core (4個)](#01-core-4個)
  - [索引文件 (1個)](#索引文件-1個)
- [✅ 已完成的移動](#已完成的移動)
...
- [🎯 整理原則](#整理原則)
  ...
  - [📄 保留在 docs/user_guides/](#保留在-docsuser-guides)
...
**整理日期**: 2025年11月22日  
**目標**: 將所有指南集中到 `C:\D\fold7\AIVA-git\guides\` 目錄
...
### Core 模組 (2個)
1. `services/core/aiva_core/USAGE_GUIDE.md`
   - Core 模組使用說明
...
4. `services/scan/coordinators/COORDINATOR_USAGE_GUIDE.md`
   - 協調器使用指南

5. `services/scan/coordinators/PYTHON_ENGINE_USAGE_GUIDE.md`
   - Python 引擎使用

6. `services/scan/engines/go_engine/USAGE_GUIDE.md`
   - Go 引擎使用

7. `services/scan/engines/rust_engine/USAGE_GUIDE.md`
   - Rust 引擎使用
