...
- [📄 本目錄檔案說明](#-本目錄檔案說明)
  - [🎯 核心功能測試](#-核心功能測試)
  - [🔍 檢測器測試 (`detectors/`)](#-檢測器測試-detectors)
  - [🧪 測試工具 (`testers/`)](#-測試工具-testers)
- [🚀 使用方法](#-使用方法)
  - [執行功能特性測試](#執行功能特性測試)
  - [執行檢測器測試](#執行檢測器測試)
  - [執行權限測試工具](#執行權限測試工具)
- [🛠️ 功能測試組件](#-功能測試組件)
  - [AIVA 綜合測試 (`aiva_final_test.py`)](#aiva-綜合測試-aiva_final_testpy)
  - [漏洞利用功能測試 (`test_exploit_functionality.py`)](#漏洞利用功能測試-test_exploit_functionalitypy)
  - [真實攻擊執行器 (`real_attack_executor.py`)](#真實攻擊執行器-real_attack_executorpy)
  - [加密檢測器測試 (`detectors/test_detector.py`)](#加密檢測器測試-detectorstest_detectorpy)
  - [權限測試工具](#權限測試工具)
- [📝 編寫新的功能測試](#-編寫新的功能測試)
  - [測試檔案命名規範](#測試檔案命名規範)
  - [功能測試結構範例](#功能測試結構範例)
