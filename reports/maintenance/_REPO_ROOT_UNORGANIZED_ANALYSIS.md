...
### 🔴 高優先級項目
- [1. reports/ - 報告目錄 (263 檔案)](#1-reports---報告目錄-263-檔案--最大問題)
- [2. logs/ - 日誌目錄 (255 檔案)](#2-logs---日誌目錄-255-檔案--次大問題)
- [3. target/ - Rust 編譯產物 (366 檔案)](#3-target---rust-編譯產物-366-檔案--應該被-gitignore)

### 🟡 中優先級項目
- [4. docker/ - Docker 配置目錄 (31 檔案)](#4-docker---docker-配置目錄-31-檔案)
- [5. docs/ - 文檔目錄 (26 檔案)](#5-docs---文檔目錄-26-檔案)
- [6. guides/ - 指南目錄 (15 檔案)](#6-guides---指南目錄-15-檔案)
- [7. config/ - 配置目錄 (12 檔案)](#7-config---配置目錄-12-檔案)
- [8. data/ - 資料目錄 (21 檔案)](#8-data---資料目錄-21-檔案)
- [9. api/ - API 服務目錄 (9 檔案)](#9-api---api-服務目錄-9-檔案)
- [10. src/ - 源碼目錄 (9 檔案)](#10-src---源碼目錄-9-檔案)

### 🟢 低優先級項目
- [11-19. 其他小型目錄](#低優先級---可以保持現狀或輕度整理-50-檔案)

### 🔵 臨時/快取目錄
- [20-24. 快取和編譯產物](#臨時快取目錄---應該被清理或忽略-380-檔案)
...
### 🎯 行動計畫
- [整理優先級矩陣](#整理優先級矩陣)
- [立即行動清單 (P0 項目)](#立即行動清單-p0-項目)
- [整理後的理想目錄結構](#整理後的理想目錄結構)
- [完整整理計畫時程](#完整整理計畫時程)

### 💡 最佳實踐
- [.gitignore 管理](#1-gitignore-管理)
- [目錄命名規範](#2-目錄命名規範)
- [檔案組織原則](#3-檔案組織原則)
- [文檔維護](#4-文檔維護)
