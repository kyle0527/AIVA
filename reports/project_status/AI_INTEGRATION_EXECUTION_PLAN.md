...
- [📊 現況分析](#現況分析)
  ...
  - [❌ **缺失的組件**](#缺失的組件)
- [🎯 整合方案設計](#整合方案設計)
  - [**核心理念: AI 自我認知循環**](#核心理念-ai-自我認知循環)
  - [**五大模組結構**](#五大模組結構)
  - [**新增組件架構**](#新增組件架構)
- [📝 詳細執行計劃](#詳細執行計劃)
  - [**Phase 1: 模組探索器 (ModuleExplorer)** ✅ **已完成**](#phase-1-模組探索器-moduleexplorer-已完成)
  - [**Phase 2: 能力分析器 (CapabilityAnalyzer)** 📊](#phase-2-能力分析器-capabilityanalyzer)
  - [**Phase 3: 效能評估器 (PerformanceEvaluator)** ⚡](#phase-3-效能評估器-performanceevaluator)
  - [**Phase 4: 優化顧問 (OptimizationAdvisor)** 🔧](#phase-4-優化顧問-optimizationadvisor)
  - [**Phase 5: RAG 知識整合** 📚](#phase-5-rag-知識整合)
- [📂 文件清單與代碼量估算](#文件清單與代碼量估算)
- [🧪 測試計劃](#測試計劃)
  - [**單元測試** (Unit Tests)](#單元測試-unit-tests)
  - [**集成測試** (Integration Tests)](#集成測試-integration-tests)
- [⚠️ 風險評估與緩解措施](#風險評估與緩解措施)
- [⏱️ 時間安排](#時間安排)
- [🎯 關鍵決策點](#關鍵決策點)
  - [**決策點 1: CapabilityRegistry 增強方案**](#決策點-1-capabilityregistry-增強方案)
  - [**決策點 2: 探索頻率**](#決策點-2-探索頻率)
  - [**決策點 3: AI 語義分析範圍**](#決策點-3-ai-語義分析範圍)
  - [**決策點 4: 優化建議執行方式**](#決策點-4-優化建議執行方式)
  - [**決策點 5: RAG 知識範圍**](#決策點-5-rag-知識範圍)
- [📝 執行檢查清單](#執行檢查清單)
- [🚀 執行流程](#執行流程)
  - [**Step 1: 環境準備**](#step-1-環境準備)
  - [**Step 2: Phase 1 實施**](#step-2-phase-1-實施)
  - [**Step 3: 依次實施 Phase 2-5**](#step-3-依次實施-phase-25)
  - [**Step 4: 整合測試**](#step-4-整合測試)
  - [**Step 5: 文檔補充**](#step-5-文檔補充)
- [✅ 驗收標準](#驗收標準)
- [🎓 後續擴展方向](#後續擴展方向)
- [📌 下一步行動](#下一步行動)
- [📋 附錄: 五大模組概覽](#附錄-五大模組概覽)
  - [**1. Core (核心模組)**](#1-core-核心模組)
  - [**2. Common (共享模組)**](#2-common-共享模組)
  - [**3. Features (功能模組)**](#3-features-功能模組)
  - [**4. Integration (整合模組)**](#4-integration-整合模組)
  - [**5. Scan (掃描模組)**](#5-scan-掃描模組)
  - [**Phase 4: 優化顧問 (OptimizationAdvisor)** 🔧](#phase-4-優化顧問-optimizationadvisor-1)
- [📋 檔案清單](#檔案清單)
  - [**新建檔案** (共 5 個)](#新建檔案-共-5-個)
  - [**修改檔案** (共 3 個)](#修改檔案-共-3-個)
- [🔄 執行步驟](#執行步驟)
  - [**建議分階段執行**](#建議分階段執行)
    - [**第 1 天: Phase 1 - 代碼探索器**](#第-1-天-phase-1-代碼探索器)
    - [**第 2 天: Phase 2 - 攻擊生成器**](#第-2-天-phase-2-攻擊生成器)
    - [**第 3 天: Phase 3 - 自我修復器**](#第-3-天-phase-3-自我修復器)
    - [**第 4 天: Phase 4 - RAG 知識庫**](#第-4-天-phase-4-rag-知識庫)
    - [**第 5 天: Phase 5 - 統一入口**](#第-5-天-phase-5-統一入口)
- [🧪 測試計劃](#測試計劃-1)
  - [**單元測試**](#單元測試)
  - [**整合測試**](#整合測試)
- [⚠️ 風險評估](#風險評估)
