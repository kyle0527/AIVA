...
- [📋 問題背景](#問題背景)
  - [原始錯誤](#原始錯誤)
  - [根本原因](#根本原因)
- [✅ 已完成的修復 (階段 1-2)](#已完成的修復-階段-12)
  - [階段 1: 特殊案例修復](#階段-1-特殊案例修復)
  - [階段 2: 批量修復 core 模組](#階段-2-批量修復-core-模組)
  - [測試環境配置](#測試環境配置)
- [✅ 當前狀態](#當前狀態)
- [🔍 待修復問題清單](#待修復問題清單)
  - [Category A: `from services.xxx` 導入 (100+ 個檔案)](#category-a-from-servicesxxx-導入-100-個檔案)
- [🎯 修復策略](#修復策略)
  - [網路最佳實踐 (StackOverflow 最高票答案)](#網路最佳實踐-stackoverflow-最高票答案)
  - [當前方案: conftest.py + sys.path](#當前方案-conftestpy-syspath)
- [📊 專案結構分析](#專案結構分析)
  - [現有 pyproject.toml 檔案](#現有-pyprojecttoml-檔案)
  - [安裝狀態](#安裝狀態)
- [🚨 關鍵決策點](#關鍵決策點)
  - [選項 A: 標準化方案 (推薦)](#選項-a-標準化方案-推薦)
  - [選項 B: 繼續當前方案](#選項-b-繼續當前方案)
- [📝 開發標準 (DEVELOPMENT_STANDARDS.md)](#開發標準-developmentstandardsmd)
  - [正確導入方式](#正確導入方式)
  - [模組間依賴規則](#模組間依賴規則)
- [🔄 下一步行動](#下一步行動)
  - [待決策](#待決策)
  - [待完成 (選項 B 情況下)](#待完成-選項-b-情況下)
- [📈 修復統計](#修復統計)
- [💡 建議](#建議)
- [📚 參考資料](#參考資料)
