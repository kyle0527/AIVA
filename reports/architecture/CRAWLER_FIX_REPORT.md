...
- [🎯 完成的修復](#完成的修復)
  - [1. **策略映射層** ✅](#1-策略映射層)
  - [2. **URL 隊列深度追蹤** ✅](#2-url-隊列深度追蹤)
  - [3. **爬蟲鏈結加入隊列** ✅](#3-爬蟲鏈結加入隊列)
- [⚠️ 發現的架構問題](#發現的架構問題)
  - [**核心問題: Juice Shop 是 SPA 應用**](#核心問題-juice-shop-是-spa-應用)
    - [現象](#現象)
    - [原因分析](#原因分析)
    - [影響範圍](#影響範圍)
- [🔧 需要的後續修復](#需要的後續修復)
  - [選項 A: **啟用動態掃描** (建議)](#選項-a-啟用動態掃描-建議)
  - [選項 B: **改進 JS 分析器** (中期)](#選項-b-改進-js-分析器-中期)
  - [選項 C: **API 優先掃描** (長期)](#選項-c-api-優先掃描-長期)
- [📊 測試結果對比](#測試結果對比)
- [🎓 從 Crawlee-Python 學到的最佳實踐](#從-crawleepython-學到的最佳實踐)
  - [1. **Request 物件模式**](#1-request-物件模式)
  - [2. **自動深度管理**](#2-自動深度管理)
  - [3. **持久化隊列**](#3-持久化隊列)
  - [4. **混合模式**](#4-混合模式)
- [✅ 當前狀態總結](#當前狀態總結)
