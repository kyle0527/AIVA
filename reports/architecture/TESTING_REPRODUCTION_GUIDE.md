...
- [僅限特殊測試情境（Docker 環境）](#僅限特殊測試情境docker-環境)
  ...
  - [🎯 重現所有成功測試 (15分鐘)](#重現所有成功測試-15分鐘)
    - [1. Scanner 組件測試 (3分鐘)](#1-scanner-組件測試-3分鐘)
    - [2. Testing 組件測試 (5分鐘)](#2-testing-組件測試-5分鐘)
    - [3. Explorer 組件測試 (3分鐘)](#3-explorer-組件測試-3分鐘)
    - [4. 組件間通信測試 (1分鐘)](#4-組件間通信測試-1分鐘)
    - [5. Validator 組件測試 (2分鐘)](#5-validator-組件測試-2分鐘)
    - [6. 數據持久化測試 (1分鐘)](#6-數據持久化測試-1分鐘)
- [❌ 已知未修復問題](#已知未修復問題)
  - [動態組件管理失敗](#動態組件管理失敗)
