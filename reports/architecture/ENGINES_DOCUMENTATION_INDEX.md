...
- [📚 文檔導航](#文檔導航)
  - [Rust Engine (Phase0 核心引擎)](#rust-engine-phase0-核心引擎)
  - [Python Engine (Phase1 主力引擎)](#python-engine-phase1-主力引擎)
  - [TypeScript Engine (Phase1 SPA 專家)](#typescript-engine-phase1-spa-專家)
  - [Go Engine (Phase1 高並發掃描器)](#go-engine-phase1-高並發掃描器)
- [📊 引擎對比速查表](#引擎對比速查表)
  - [掃描模式總覽](#掃描模式總覽)
  - [詳細模式對照](#詳細模式對照)
    - [Rust Engine - 3 種模式](#rust-engine-3-種模式)
    - [Python Engine - 7 種策略](#python-engine-7-種策略)
    - [TypeScript Engine - 5 種模式（自動啟用）](#typescript-engine-5-種模式自動啟用)
    - [Go Engine - 3 種掃描器](#go-engine-3-種掃描器)
  - [功能矩陣](#功能矩陣)
  - [性能對比](#性能對比)
  - [最佳使用場景](#最佳使用場景)
...
- [🎯 引擎選擇決策樹](#引擎選擇決策樹)
- [📋 引擎狀態總覽](#引擎狀態總覽)
  - [Rust Engine ✅](#rust-engine-1)
  - [Python Engine ⚠️](#python-engine-1)
  - [TypeScript Engine ⚠️](#typescript-engine-1)
  - [Go Engine ⚠️](#go-engine-1)
- [🚀 後續行動計劃](#後續行動計劃)
  - [短期 (1-2 週)](#短期-12-週)
    - [優先級 1: Python Engine 驗證](#優先級-1-python-engine-驗證)
    - [優先級 2: TypeScript Engine 驗證](#優先級-2-typescript-engine-驗證)
    - [優先級 3: Go Engine 驗證](#優先級-3-go-engine-驗證)
  - [中期 (2-4 週)](#中期-24-週)
    - [Rust Engine 優化](#rust-engine-優化)
    - [Python Engine 改進](#python-engine-改進)
    - [TypeScript Engine 完善](#typescript-engine-完善)
    - [Go Engine 增強](#go-engine-增強)
  - [長期 (1-2 月)](#長期-12-月)
    - [多引擎協調優化](#多引擎協調優化)
    - [文檔和示例](#文檔和示例)
- [📞 技術支持](#技術支持)
  ...
  - [通用資源](#通用資源)
- [📝 版本歷史](#版本歷史)
  - [v1.1.0 (2025-11-22) - 模式完整化 ✨ 最新](#v110-20251122-模式完整化-最新)
  - [v1.0.0 (2025-11-19)](#v100-20251119)
  - [預定 v1.2.0](#預定-v120)
  - [預定 v2.0.0](#預定-v200)
...
| **使用指南** | `docs/guides/services/rust_engine_USAGE_GUIDE.md` | 詳細使用說明、模式切換 |
...
| **使用指南** | `docs/guides/services/rust_engine_USAGE_GUIDE.md` | 詳細使用說明 |
...
- **Rust Engine**: 參考 `docs/guides/services/rust_engine_USAGE_GUIDE.md`
