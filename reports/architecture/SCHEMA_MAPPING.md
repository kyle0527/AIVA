...
- [欄位名稱對照](#欄位名稱對照)
  ...
  - [Target (FindingTarget)](#target-findingtarget)
  - [FindingEvidence](#findingevidence)
  - [FindingImpact](#findingimpact)
  - [FindingRecommendation](#findingrecommendation)
  - [FunctionTaskPayload](#functiontaskpayload)
  - [FunctionTaskTarget](#functiontasktarget)
  - [FunctionTaskContext](#functiontaskcontext)
  - [FunctionTaskTestConfig](#functiontasktestconfig)
- [命名規範](#命名規範)
  - [Go 命名](#go-命名)
  - [Python 命名](#python-命名)
- [差異分析](#差異分析)
  - [現有問題](#現有問題)
- [遷移策略](#遷移策略)
  - [Phase 1: 擴充 Go schemas ✅](#phase-1-擴充-go-schemas)
  - [Phase 2: 統一命名 ✅](#phase-2-統一命名)
  - [Phase 3: 移除本地 models 🔄](#phase-3-移除本地-models)
  - [Phase 4: 添加測試 ✅](#phase-4-添加測試)
- [測試策略](#測試策略)
  - [單元測試](#單元測試)
  - [互操作測試](#互操作測試)
- [維護指南](#維護指南)
  - [添加新 Schema](#添加新-schema)
