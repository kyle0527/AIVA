...
- [🆕 新增的現代化腳本](#-新增的現代化腳本)
  - [📍 腳本位置](#-腳本位置)
- [🚀 快速開始指南](#-快速開始指南)
  - [第一次使用 AIVA？](#第一次使用-aiva)
  - [日常使用工作流](#日常使用工作流)
- [📚 詳細使用說明](#-詳細使用說明)
  - [1️⃣ setup_environment.ps1 - 環境設置](#1-setup_environmentps1---環境設置)
  - [2️⃣ diagnose_system.ps1 - 系統診斷](#2-diagnose_systemps1---系統診斷)
  - [3️⃣ start_system.ps1 - 系統啟動](#3-start_systemps1---系統啟動)
  - [4️⃣ health_check.ps1 - 健康檢查](#4-health_checkps1---健康檢查)
  - [5️⃣ stop_system.ps1 - 系統停止](#5-stop_systemps1---系統停止)
- [🎯 常見使用場景](#-常見使用場景)
  - [場景 A: 完整開發環境設置](#場景-a-完整開發環境設置)
  - [場景 B: 快速 API 開發](#場景-b-快速-api-開發)
  - [場景 C: 問題排查](#場景-c-問題排查)
  - [場景 D: 每日工作流程](#場景-d-每日工作流程)
- [🔧 進階技巧](#-進階技巧)
  - [創建快捷啟動別名](#創建快捷啟動別名)
- [❓ 常見問題](#-常見問題)
- [📊 腳本對比](#-腳本對比)
