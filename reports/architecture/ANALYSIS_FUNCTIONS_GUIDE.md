...
- [🎯 核心分析機制](#核心分析機制)
  - [1. 組織方式發現原理](#1-組織方式發現原理)
    - [🔍 V1.0 基礎維度分析 (144種方式)](#v10-基礎維度分析-144種方式)
    - [🚀 V2.0 擴展分析 (30種新方式)](#v20-擴展分析-30種新方式)
    - [⚡ V3.0 統一架構機制](#v30-統一架構機制)
  - [2. 組件特徵提取機制](#2-組件特徵提取機制)
    - [📊 基礎特徵維度](#基礎特徵維度)
    - [🎨 智能分組算法](#智能分組算法)
  - [3. 品質保證機制](#3-品質保證機制)
    - [✅ 自動驗證系統](#自動驗證系統)
...
- [🗂️ 圖表管理機制](#圖表管理機制)
  ...
  - [2. 圖表分類規則](#2-圖表分類規則)
- [📈 功能運作實例](#功能運作實例)
  - [實例1: 品質分析機制](#實例1-品質分析機制)
  - [實例2: 語義分析機制](#實例2-語義分析機制)
- [🔧 配置驅動機制](#配置驅動機制)
  - [分析配置範例](#分析配置範例)
- [📚 重要注意事項](#重要注意事項)
  - [1. 結果穩定性](#1-結果穩定性)
