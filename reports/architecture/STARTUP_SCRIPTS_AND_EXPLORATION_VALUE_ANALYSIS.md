...
- [🚀 Part 1: 啟動腳本必要性分析](#part-1-啟動腳本必要性分析)
  ...
  - [當前腳本狀況](#當前腳本狀況)
- [📊 詳細分析](#詳細分析)
  - [1. setup_environment.ps1 - **建議移除** ❌](#1-setup-environmentps1-建議移除)
  - [2. start_system.ps1 - **可大幅簡化** ⚠️](#2-start-systemps1-可大幅簡化)
  - [3. stop_system.ps1 - **可大幅簡化** ⚠️](#3-stop-systemps1-可大幅簡化)
  - [4. health_check.ps1 - **建議移除,改用 API** ❌](#4-health-checkps1-建議移除改用-api)
  - [5. diagnose_system.ps1 - **保留** ✅](#5-diagnose-systemps1-保留)
- [🎯 最終推薦方案](#最終推薦方案)
  - [新的腳本結構](#新的腳本結構)
  - [launch_aiva.ps1 (新統一腳本)](#launch-aivaps1-新統一腳本)
  - [stop_aiva.ps1 (新統一腳本)](#stop-aivaps1-新統一腳本)
- [📉 簡化效益](#簡化效益)
...
- [🔍 探索數據的具體內容](#探索數據的具體內容)
  - [數據結構](#數據結構)
  - [實際統計 (2025-11-16)](#實際統計-2025-11-16)
- [💡 探索數據的價值證明](#探索數據的價值證明)
  - [實驗對比](#實驗對比)
- [🎯 總結](#總結)
