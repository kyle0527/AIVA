...
- [📋 目錄](#-目錄)
  - [核心概念](#核心概念)
  - [使用場景 (所有範例基於 AI 命令中心)](#使用場景-所有範例基於-ai-命令中心)
  - [注意事項](#注意事項)
  - [總結與最佳實踐](#總結與最佳實踐)
- [🔧 引擎特性對照表](#-引擎特性對照表)
- [🎯 使用場景與引擎選擇](#-使用場景與引擎選擇)
  - [🔴 核心概念:協調器的真正作用](#-核心概念協調器的真正作用)
  - [✅ 正確的調用方式:通過 ScanCommandHandler](#-正確的調用方式通過-scancommandhandler)
  - [1️⃣ Phase 0 快速偵察 (Rust 引擎)](#1-phase-0-快速偵察-rust-引擎)
  - [2️⃣ Phase 1 單引擎深度掃描](#2-phase-1-單引擎深度掃描)
  - [3️⃣ Phase 1 雙引擎組合](#3-phase-1-雙引擎組合)
  - [4️⃣ Phase 1 三引擎協同](#4-phase-1-三引擎協同)
  - [5️⃣ Phase 0 → Phase 1 完整流程](#5-phase-0--phase-1-完整流程)
  - [6️⃣ 綜合掃描命令 (一鍵執行)](#6-綜合掃描命令-一鍵執行)
  - [7️⃣ 多目標並行掃描](#7-多目標並行掃描)
- [⚠️ 常見錯誤:直接調用協調器](#-常見錯誤直接調用協調器)
- [📊 協調器功能總結](#-協調器功能總結)
  - [核心能力](#核心能力)
  - [引擎選擇策略](#引擎選擇策略)
  - [使用模式比較](#使用模式比較)
- [🎓 最佳實踐](#-最佳實踐)
  - [1. 始終通過 AI 命令中心](#1-始終通過-ai-命令中心)
  - [2. 根據需求選擇引擎](#2-根據需求選擇引擎)
  - [3. Phase 0 → Phase 1 決策](#3-phase-0--phase-1-決策)
  - [4. 監控與調優](#4-監控與調優)
- [📖 延伸閱讀](#-延伸閱讀)
- [🎯 常見使用模式總結](#-常見使用模式總結)
- [🔗 相關文檔](#-相關文檔)
...
- [Python Engine 指南](../../docs/guides/services/rust_engine_USAGE_GUIDE.md)
- [Rust Engine 指南](../../docs/guides/services/rust_engine_USAGE_GUIDE.md)
- [Go Engine 指南](../../docs/guides/services/rust_engine_USAGE_GUIDE.md)
