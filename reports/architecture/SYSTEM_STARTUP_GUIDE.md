...
- [🎯 架構概覽](#架構概覽)
  - [系統層次（明確的主從關係）](#系統層次明確的主從關係)
- [🚀 啟動流程](#啟動流程)
  - [1. 啟動命令](#1-啟動命令)
  - [2. 啟動序列（詳細步驟）](#2-啟動序列詳細步驟)
    - [Phase 1: FastAPI 應用初始化](#phase-1-fastapi-應用初始化)
    - [Phase 2: CoreServiceCoordinator 初始化](#phase-2-coreservicecoordinator-初始化)
    - [Phase 3: 內部閉環啟動（P0 問題一）](#phase-3-內部閉環啟動p0-問題一)
    - [Phase 4: 外部學習循環啟動（P0 問題二）](#phase-4-外部學習循環啟動p0-問題二)
    - [Phase 5: 核心處理循環啟動](#phase-5-核心處理循環啟動)
    - [Phase 6: 系統就緒](#phase-6-系統就緒)
  - [3. 啟動日誌示例](#3-啟動日誌示例)
- [🔌 健康檢查](#健康檢查)
  - [檢查系統狀態](#檢查系統狀態)
  - [檢查掃描狀態](#檢查掃描狀態)
- [🛑 優雅關閉](#優雅關閉)
  - [關閉流程](#關閉流程)
    - [Phase 1: 觸發 Shutdown Event](#phase-1-觸發-shutdown-event)
    - [Phase 2: 停止 CoreServiceCoordinator](#phase-2-停止-coreservicecoordinator)
    - [Phase 3: 取消後台任務](#phase-3-取消後台任務)
    - [Phase 4: 關閉完成](#phase-4-關閉完成)
- [📦 組件職責明細](#組件職責明細)
  - [app.py（系統唯一入口）](#apppy系統唯一入口)
  - [CoreServiceCoordinator（狀態管理器）](#coreservicecoordinator狀態管理器)
  - [BioNeuronDecisionController（AI 決策控制器）](#bioneurondecisioncontrollerai-決策控制器)
- [🔧 故障排除](#故障排除)
  - [問題 1: 啟動超時](#問題-1-啟動超時)
  - [問題 2: 後台任務異常退出](#問題-2-後台任務異常退出)
  - [問題 3: 重複啟動](#問題-3-重複啟動)
- [📚 相關文檔](#相關文檔)
- [🎯 關鍵要點](#關鍵要點)
  - [✅ 明確的主從關係](#明確的主從關係)
