...
- [🖥️ 系統需求](#系統需求)
  ...
  - [作業系統](#作業系統)
- [🔧 核心運行時環境](#核心運行時環境)
  - [1. Python 環境 ⭐⭐⭐ 必需](#1-python-環境-必需)
    - [版本要求](#版本要求)
    - [安裝方式](#安裝方式)
    - [Python 套件依賴](#python-套件依賴)
      - [核心依賴 (生產必需)](#核心依賴-生產必需)
      - [安裝命令](#安裝命令)
  - [2. Node.js 環境 ⭐⭐⭐ 必需 (TypeScript Engine)](#2-nodejs-環境-必需-typescript-engine)
    - [版本要求](#版本要求-1)
    - [安裝方式](#安裝方式-1)
    - [Node.js 套件依賴](#nodejs-套件依賴)
      - [TypeScript Engine 依賴](#typescript-engine-依賴)
  - [3. Go 環境 ⭐⭐ 重要 (部分 Feature 模組)](#3-go-環境-重要-部分-feature-模組)
    - [版本要求](#版本要求-1)
    - [安裝方式](#安裝方式-1)
    - [Go 模組依賴](#go-模組依賴)
  - [4. Rust 環境 ⭐ 可選 (SAST、Scan Engine)](#4-rust-環境-可選-sastscan-engine)
    - [版本要求](#版本要求-1)
    - [安裝方式](#安裝方式-1)
    - [Rust 模組依賴](#rust-模組依賴)
- [🗄️ 資料庫與中介軟體](#資料庫與中介軟體)
  - [1. PostgreSQL ⭐⭐⭐ 必需](#1-postgresql-必需)
    - [版本要求](#版本要求-1)
    - [用途](#用途)
    - [安裝方式](#安裝方式-1)
    - [配置需求](#配置需求)
  - [2. RabbitMQ ⭐ 可選 (已部分棄用)](#2-rabbitmq-可選-已部分棄用)
    - [版本要求](#版本要求-1)
    - [狀態](#狀態)
    - [安裝方式 (可選)](#安裝方式-可選)
  - [3. Redis ⭐⭐ 重要 (快取與任務佇列)](#3-redis-重要-快取與任務佇列)
    - [版本要求](#版本要求-1)
    - [用途](#用途-1)
    - [安裝方式](#安裝方式-1)
- [🔨 編譯工具](#編譯工具)
  - [Windows](#windows)
    - [Visual Studio Build Tools ⭐⭐ 重要](#visual-studio-build-tools-重要)
  - [Linux](#linux)
    - [編譯工具鏈 ⭐⭐ 重要](#編譯工具鏈-重要)
    - [系統依賴庫](#系統依賴庫)
- [📦 系統特定依賴](#系統特定依賴)
  - [Playwright 瀏覽器依賴](#playwright-瀏覽器依賴)
    - [Linux 額外依賴](#linux-額外依賴)
- [🚀 完整安裝流程](#完整安裝流程)
...
- [📋 依賴摘要](#依賴摘要)
  - [運行時環境](#運行時環境)
  - [資料庫與中介軟體](#資料庫與中介軟體-1)
  - [關鍵 Python 套件](#關鍵-python-套件)
  - [關鍵 Node.js 套件](#關鍵-nodejs-套件)
- [📝 注意事項](#注意事項)
  - [生產環境特別注意](#生產環境特別注意)
- [🔗 相關文檔](#相關文檔)
