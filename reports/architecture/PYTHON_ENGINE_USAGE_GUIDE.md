...
- [🎯 使用場景](#-使用場景)
  ...
  - [3️⃣ 深度掃描](#3-深度掃描)
  - [4️⃣ 智能掃描](#4-智能掃描)
  - [5️⃣ 自定義引擎組合](#5-自定義引擎組合)
- [⚙️ 參數配置](#-參數配置)
  - [scan_id 格式規範](#scan_id-格式規範)
  - [掃描深度控制](#掃描深度控制)
  - [多目標掃描](#多目標掃描)
  - [Phase 0 結果利用](#phase-0-結果利用)
- [📊 結果處理](#-結果處理)
  - [Phase1CompletedPayload 結構](#phase1completedpayload-結構)
  - [Summary 對象使用](#summary-對象使用)
  - [引擎結果分析](#引擎結果分析)
  - [資產類型統計](#資產類型統計)
  - [表單和 API 端點提取](#表單和-api-端點提取)
- [🚀 高級用法](#-高級用法)
  - [初始化協調器 (推薦)](#初始化協調器-推薦)
  - [錯誤處理](#錯誤處理)
  - [超時控制](#超時控制)
...
- [協調器使用指南](../../docs/guides/services/rust_engine_USAGE_GUIDE.md) - 多引擎組合模式
