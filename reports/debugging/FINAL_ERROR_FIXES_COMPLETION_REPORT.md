...
- [修復統計](#修復統計)
  - [異常類型分布](#異常類型分布)
  - [ErrorType 使用分布](#errortype-使用分布)
  - [ErrorSeverity 使用分布](#errorseverity-使用分布)
- [修復的模組清單](#修復的模組清單)
  - [Phase 1: 阻塞性錯誤 (P0)](#phase-1-阻塞性錯誤-p0)
  - [Phase 2: 標準異常轉換 (P1)](#phase-2-標準異常轉換-p1)
    - [2A. UI Schemas (已完成)](#2a-ui-schemas-已完成)
    - [2B. 業務邏輯 (已完成)](#2b-業務邏輯-已完成)
    - [2C. 規劃器模組 (已完成)](#2c-規劃器模組-已完成)
    - [2D. 執行規劃器 (已完成)](#2d-執行規劃器-已完成)
    - [2E. 核心服務 (已完成)](#2e-核心服務-已完成)
    - [2F. AI 分析引擎 (已完成)](#2f-ai-分析引擎-已完成)
    - [2G. 權重管理 (已完成)](#2g-權重管理-已完成)
    - [2H. UI 面板 (已完成)](#2h-ui-面板-已完成)
    - [2I. 之前已修復的模組](#2i-之前已修復的模組)
- [修復模式](#修復模式)
  - [標準修復模式](#標準修復模式)
  - [ErrorType 選擇策略](#errortype-選擇策略)
  - [ErrorSeverity 選擇策略](#errorseverity-選擇策略)
- [驗證結果](#驗證結果)
  - [自動化驗證](#自動化驗證)
  - [錯誤檢查驗證](#錯誤檢查驗證)
- [剩餘問題](#剩餘問題)
  - [P2: 代碼質量問題 (非阻塞)](#p2-代碼質量問題-非阻塞)
- [合規性檢查](#合規性檢查)
  - [✅ aiva_common README 規範符合度](#aivacommon-readme-規範符合度)
  - [✅ 錯誤處理最佳實踐](#錯誤處理最佳實踐)
- [性能影響](#性能影響)
  - [修復前後對比](#修復前後對比)
  - [代碼質量提升](#代碼質量提升)
