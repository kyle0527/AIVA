...
- [一、掃描引擎模組 (Scan Engines)](#一掃描引擎模組-scan-engines)
  - [1.1 引擎架構概覽](#11-引擎架構概覽)
  - [1.2 掃描階段 (ScanPhase)](#12-掃描階段-scanphase)
  - [1.3 預設掃描策略 (5 種)](#13-預設掃描策略-5-種)
    - [策略 1: `execute_strategy_fast` - 快速掃描](#策略-1-executestrategyfast-快速掃描)
    - [策略 2: `execute_strategy_balanced` - 均衡掃描](#策略-2-executestrategybalanced-均衡掃描)
    - [策略 3: `execute_strategy_comprehensive` - 全面掃描](#策略-3-executestrategycomprehensive-全面掃描)
    - [策略 4: `execute_strategy_aggressive` - 激進掃描](#策略-4-executestrategyaggressive-激進掃描)
    - [策略 5: `execute_strategy_smart` - 智能掃描](#策略-5-executestrategysmart-智能掃描)
  - [1.4 Phase 執行方法 (2 個)](#14-phase-執行方法-2-個)
    - [Phase 0: 快速偵察](#phase-0-快速偵察)
    - [Phase 1: 深度掃描](#phase-1-深度掃描)
  - [1.5 掃描模組總結](#15-掃描模組總結)
- [二、功能模組 (Feature Modules)](#二功能模組-feature-modules)
  - [2.1 功能模組架構](#21-功能模組架構)
  - [2.2 SQLi 模組 (function_sqli) ✅](#22-sqli-模組-functionsqli)
    - [實現狀態](#實現狀態)
    - [檢測引擎列表](#檢測引擎列表)
    - [Worker 介面](#worker-介面)
    - [支援的 Topic](#支援的-topic)
  - [2.3 XSS 模組 (function_xss) ✅](#23-xss-模組-functionxss)
    - [實現狀態](#實現狀態-1)
    - [檢測器列表](#檢測器列表)
    - [工具引擎](#工具引擎)
    - [Worker 介面](#worker-介面-1)
  - [2.4 SSRF 模組 (function_ssrf) ✅](#24-ssrf-模組-functionssrf)
    - [實現狀態](#實現狀態-1)
    - [核心組件](#核心組件)
    - [Worker 介面](#worker-介面-1)
  - [2.5 IDOR 模組 (function_idor) ⚠️](#25-idor-模組-functionidor)
    - [實現狀態](#實現狀態-1)
    - [實現的組件](#實現的組件)
    - [⚠️ 缺少的組件（使用佔位符）](#缺少的組件使用佔位符)
    - [Worker 介面](#worker-介面-1)
  - [2.6 PostEx 模組 (function_postex) ✅](#26-postex-模組-functionpostex)
    - [實現狀態](#實現狀態-1)
    - [檢測引擎](#檢測引擎)
    - [Worker 介面](#worker-介面-1)
  - [2.7 Crypto 模組 (function_crypto) ✅](#27-crypto-模組-functioncrypto)
    - [實現狀態](#實現狀態-1)
    - [功能](#功能)
    - [Worker 介面](#worker-介面-1)
  - [2.8 BizLogic 模組 (function_bizlogic) ❌](#28-bizlogic-模組-functionbizlogic)
    - [實現狀態](#實現狀態-1)
    - [⚠️ 缺少的組件](#缺少的組件)
    - [當前狀態](#當前狀態)
  - [2.9 AuthN Go 模組 (function_authn_go) ❓](#29-authn-go-模組-functionauthngo)
    - [實現狀態](#實現狀態-1)
    - [目錄結構](#目錄結構)
  - [2.10 工具整合模組 ⚠️](#210-工具整合模組)
    - [DDoS 工具 (function_ddos)](#ddos-工具-functionddos)
    - [Web Scanner 工具 (function_web_scanner)](#web-scanner-工具-functionwebscanner)
- [三、功能模組總結表](#三功能模組總結表)
  - [功能模組統計](#功能模組統計)
- [四、實際可用性評估](#四實際可用性評估)
  - [4.1 掃描模組可用性](#41-掃描模組可用性)
  - [4.2 功能模組可用性](#42-功能模組可用性)
  - [4.3 總體評估](#43-總體評估)
- [五、關鍵發現](#五關鍵發現)
  - [5.1 優勢](#51-優勢)
  - [5.2 限制](#52-限制)
  - [5.3 建議優先級](#53-建議優先級)
- [六、AI 可用操作總覽](#六ai-可用操作總覽)
  - [掃描操作 (13 種)](#掃描操作-13-種)
  - [功能操作 (6 種)](#功能操作-6-種)
- [結論](#結論)
