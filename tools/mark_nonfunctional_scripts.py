...
def main():
    # 讀取檢查結果
    result_file = Path(r'C:\D\fold7\AIVA-git\_out\script_functionality_report.json')
    tree_file = Path(r'C:\D\fold7\AIVA-git\_out\tree_ultimate_chinese_20251019_082355.txt')
    output_file = Path(r'C:\D\fold7\AIVA-git\_out\tree_with_functionality_marks.txt')
