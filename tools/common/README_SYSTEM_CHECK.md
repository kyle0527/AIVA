...
- [🛠️ 工具概覽](#-工具概覽)
  - [1. 系統健康度檢查 (`system_health_check.ps1`)](#1-系統健康度檢查-system_health_checkps1)
  - [2. Schema 驗證器 (`schema_validator.py`)](#2-schema-驗證器-schema_validatorpy)
  - [3. 改善規劃書 (`SYSTEM_IMPROVEMENT_PLAN.md`)](#3-改善規劃書-system_improvement_planmd)
- [🚀 快速開始](#-快速開始)
  - [基本檢查](#基本檢查)
  - [進階使用](#進階使用)
- [📊 檢查項目說明](#-檢查項目說明)
  - [系統健康度檢查涵蓋項目](#系統健康度檢查涵蓋項目)
  - [Schema 驗證涵蓋項目](#schema-驗證涵蓋項目)
- [📈 健康度評分標準](#-健康度評分標準)
  - [系統健康度等級](#系統健康度等級)
  - [Schema 驗證狀態](#schema-驗證狀態)
- [🔄 自動化執行](#-自動化執行)
  - [定期檢查腳本](#定期檢查腳本)
  - [CI/CD 整合](#cicd-整合)
- [🎯 問題排除](#-問題排除)
