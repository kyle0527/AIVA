...
- [🎯 目標](#-目標)
- [🚀 快速開始](#-快速開始)
  - [方法 1: 自動測試腳本（推薦）](#方法-1-自動測試腳本推薦)
  - [方法 2: 單獨使用各工具](#方法-2-單獨使用各工具)
- [📊 查看生成的流程圖](#-查看生成的流程圖)
  - [在 VS Code 中查看](#在-vs-code-中查看)
  - [在線查看](#在線查看)
  - [在 Markdown 中引用](#在-markdown-中引用)
- [函數流程圖](#函數流程圖)
- [🎨 自定義選項](#-自定義選項)
  - [調整流程圖方向](#調整流程圖方向)
  - [限制處理檔案數](#限制處理檔案數)
  - [指定輸入/輸出](#指定輸入輸出)
- [📝 實際應用案例](#-實際應用案例)
  - [案例 1: 分析 TypeScript Scan Service](#案例-1-分析-typescript-scan-service)
  - [案例 2: 分析 Rust Scanner 核心](#案例-2-分析-rust-scanner-核心)
  - [案例 3: 比較不同版本的流程](#案例-3-比較不同版本的流程)
- [🔧 疑難排解](#-疑難排解)
  - [問題 1: TypeScript 工具找不到模組](#問題-1-typescript-工具找不到模組)
  - [問題 2: Rust 工具編譯錯誤](#問題-2-rust-工具編譯錯誤)
  - [問題 3: 生成的圖表過於複雜](#問題-3-生成的圖表過於複雜)
  - [問題 4: 無法解析某些檔案](#問題-4-無法解析某些檔案)
- [📚 更多資訊](#-更多資訊)
- [💡 提示](#-提示)
- [🎯 下一步](#-下一步)
