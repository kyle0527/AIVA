...
- [🗂️ 目錄結構](#-目錄結構)
- [🔍 程式碼分析工具](#-程式碼分析工具)
  - [🔍 重複定義修復分析工具](#-重複定義修復分析工具)
  - [📊 掃描器統計分析工具](#-掃描器統計分析工具)
- [✅ 合規性與驗證工具](#-合規性與驗證工具)
  - [✅ README 合規性檢查工具](#-readme-合規性檢查工具)
  - [🎯 P0 優先級修復驗證工具](#-p0-優先級修復驗證工具)
- [🔗 架構分析工具](#-架構分析工具)
  - [🔗 整合模組深度分析工具](#-整合模組深度分析工具)
  - [🌟 終極組織架構發現工具](#-終極組織架構發現工具)
- [📈 智能分析報告](#-智能分析報告)
  - [📈 智能分析 v3 報告數據](#-智能分析-v3-報告數據)
- [🎯 分析工具使用流程](#-分析工具使用流程)
  - [🚀 AIVA 重複定義修復流程](#-aiva-重複定義修復流程)
  - [🔧 系統整體分析流程](#-系統整體分析流程)
- [🔒 AIVA v5.0 專用功能](#-aiva-v50-專用功能)
  - [🔧 重複定義修復 (duplication_fix_tool.py)](#-重複定義修復-duplication_fix_toolpy)
- [⚡ 分析工具最佳化](#-分析工具最佳化)
  - [🔍 AIVA 專用最佳化](#-aiva-專用最佳化)
  - [📊 效能最佳化](#-效能最佳化)
- [🔗 與其他服務的整合](#-與其他服務的整合)
  - [🤖 與 Core 服務整合](#-與-core-服務整合)
  - [🔄 與 Integration 服務整合](#-與-integration-服務整合)
  - [🛠️ 與 Utilities 工具整合](#-與-utilities-工具整合)
- [📋 故障排除](#-故障排除)
  - [AIVA 專用問題解決](#aiva-專用問題解決)
- [📖 相關文檔](#-相關文檔)
