...
- [📋 存放概述](#-存放概述)
  - [🎯 建立原因](#-建立原因)
- [🗂️ 分類結構](#-分類結構)
- [🚀 重複啟動器 (duplicate_launchers/)](#-重複啟動器-duplicate_launchers)
  - [📊 移除原因分析](#-移除原因分析)
  - [💡 歷史價值](#-歷史價值)
- [🔧 過時調試工具 (obsolete_debug_tools/)](#-過時調試工具-obsolete_debug_tools)
  - [📊 淘汰分析](#-淘汰分析)
  - [🔧 整合成果](#-整合成果)
- [⚠️ 衝突腳本 (conflicting_scripts/)](#-衝突腳本-conflicting_scripts)
  - [🏗️ 架構衝突原因](#-架構衝突原因)
  - [📊 移除的 PowerShell 腳本 (30+ 個)](#-移除的-powershell-腳本-30-個)
  - [📊 移除的 Shell 腳本 (20+ 個)](#-移除的-shell-腳本-20-個)
  - [✅ Python 統一化成果](#-python-統一化成果)
- [📁 工作階段檔案歸檔 (archive_session_files/)](#-工作階段檔案歸檔-archive_session_files)
  - [🗂️ 暫存檔案類型](#-暫存檔案類型)
- [🔒 安全隔離措施](#-安全隔離措施)
  - [⚠️ 防止意外使用](#-防止意外使用)
  - [📋 檔案標記範例](#-檔案標記範例)
