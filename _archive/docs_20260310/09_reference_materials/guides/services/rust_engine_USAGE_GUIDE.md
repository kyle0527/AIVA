...
- [🚀 快速開始 ✅ 已驗證 2025-11-23](#快速開始-已驗證-20251123)
  - [1. 編譯](#1-編譯)
  - [2. 基本使用](#2-基本使用)
- [📋 命令行參數 ✅ 已驗證 2025-11-23](#命令行參數-已驗證-20251123)
  - [scan 子命令](#scan-子命令)
  - [掃描模式說明](#掃描模式說明)
- [💡 使用場景 ✅ 已驗證 2025-11-23](#使用場景-已驗證-20251123)
  - [場景1: 單目標快速掃描 ✅ 已驗證](#場景1-單目標快速掃描-已驗證)
  - [場景2: 多靶場並行掃描 ✅ 已驗證 2025-11-23](#場景2-多靶場並行掃描-已驗證-20251123)
  - [場景3: 深度分析模式](#場景3-深度分析模式)
  - [場景4: 子路徑應用掃描](#場景4-子路徑應用掃描)
- [📊 輸出格式 ✅ 已驗證 2025-11-23](#輸出格式-已驗證-20251123)
  - [JSON 結構](#json-結構)
  - [解析示例 (PowerShell)](#解析示例-powershell)
- [🎯 與 AIVA 架構整合 ✅ 已修復 2025-11-23](#與-aiva-架構整合-已修復-20251123)
  - [Phase0: 快速偵察 (必執行)](#phase0-快速偵察-必執行)
  - [作為命令行工具調用 (外部集成)](#作為命令行工具調用-外部集成)
  - [AIVA 內部集成 (FFI Bridge)](#aiva-內部集成-ffi-bridge)
- [⚠️ 注意事項](#注意事項)
  - [1. 目標URL格式](#1-目標url格式)
  - [2. 超時設置建議](#2-超時設置建議)
  - [3. 並行數量限制](#3-並行數量限制)
  - [4. 子路徑應用處理](#4-子路徑應用處理)
- [🐛 常見問題](#常見問題)
  - [Q1: 為什麼某些目標掃描不到端點?](#q1-為什麼某些目標掃描不到端點)
  - [Q2: JS Findings數量為何為0?](#q2-js-findings數量為何為0)
  - [Q3: 如何處理HTTPS證書錯誤?](#q3-如何處理https證書錯誤)
  - [Q4: 掃描是否會觸發WAF?](#q4-掃描是否會觸發waf)
- [📈 性能優化建議](#性能優化建議)
  - [1. 本地測試](#1-本地測試)
  - [2. 遠程掃描](#2-遠程掃描)
  - [3. 大規模掃描](#3-大規模掃描)
- [🔄 未來功能 (OPTIMIZATION_ROADMAP.md)](#未來功能-optimizationroadmapmd)
- [📞 技術支持](#技術支持)
