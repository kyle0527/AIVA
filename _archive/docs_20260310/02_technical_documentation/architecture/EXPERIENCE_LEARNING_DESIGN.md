...
- [🎯 核心原則](#-核心原則)
- [📊 可獲得的數據類型（Data Sources）](#-可獲得的數據類型data-sources)
  - [1. **內閉環數據** (Internal Loop)](#1-內閉環數據-internal-loop)
    - [1.1 能力數據 ([ModuleCapability](../aiva_common/schemas/dual_loop.py#L240-L314))](#11-能力數據-modulecapabilityaiva_commonschemasdual_looppyl240-l314)
    - [1.2 數據流分析 ([CompleteDataFlow](../aiva_common/schemas/dual_loop.py#L141-L169))](#12-數據流分析-completedataflowaiva_commonschemasdual_looppyl141-l169)
    - [1.3 問題診斷 ([BrokenChainDiagnosis](../aiva_common/schemas/dual_loop.py#L172-L187))](#13-問題診斷-brokenchaindiagnosisaiva_commonschemasdual_looppyl172-l187)
  - [2. **外閉環數據** (External Loop)](#2-外閉環數據-external-loop)
    - [2.1 任務執行記錄 ([ExecutionTrace](tracing/trace_recorder.py#L60-L104))](#21-任務執行記錄-executiontracetracingtrace_recorderpyl60-l104)
    - [2.2 漏洞發現結果 (Features Output)](#22-漏洞發現結果-features-output)
    - [2.3 優化反饋 (Coordinator Output - Internal Loop)](#23-優化反饋-coordinator-output---internal-loop)
    - [2.4 經驗轉換 ([ExperienceTransition](experience_manager.py#L21-L62))](#24-經驗轉換-experiencetransitionexperience_managerpyl21-l62)
- [🧠 經驗學習設計（基於可獲得數據）](#-經驗學習設計基於可獲得數據)
  - [階段 1：能力效能學習 (Capability Performance Learning)](#階段-1能力效能學習-capability-performance-learning)
    - [學習目標](#學習目標)
  - [階段 2：攻擊策略學習 (Attack Strategy Learning)](#階段-2攻擊策略學習-attack-strategy-learning)
    - [學習目標](#學習目標)
  - [階段 3：決策序列學習 (Decision Sequence Learning)](#階段-3決策序列學習-decision-sequence-learning)
    - [學習目標](#學習目標)
  - [階段 4：目標特徵學習 (Target Profiling)](#階段-4目標特徵學習-target-profiling)
    - [學習目標](#學習目標)
- [📈 學習評估指標](#-學習評估指標)
  - [1. **能力效能指標**](#1-能力效能指標)
  - [2. **攻擊效果指標**](#2-攻擊效果指標)
